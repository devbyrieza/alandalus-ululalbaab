export const BRANDING = {
  schoolName: process.env.NEXT_PUBLIC_SCHOOL_NAME || "Pesantren Al Andalus Ulul Albaab",
  schoolShortName: process.env.NEXT_PUBLIC_SCHOOL_SHORT_NAME || "PPDB Ulul Albaab",
