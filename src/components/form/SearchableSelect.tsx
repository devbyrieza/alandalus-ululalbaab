  ...
  return (
    <div className="space-y-2" ref={containerRef}>
      ...
      <label className="flex items-center gap-1 text-sm font-semibold text-[var(--color-ink-700)] tracking-[-0.01em]">
        ...
        {required && (
          <span
            className="text-[var(--color-blue-600)] font-bold"
            aria-hidden="true"
          >
            *
          </span>
        ...
        <button
          ...
          className={[
            ...
            disabled
              ...
              : isOpen
                ? "bg-[var(--color-white)] border-[var(--color-blue-500)] shadow-[0_0_0_3px_rgba(3,105,199,0.10),var(--shadow-xs)] text-[var(--color-ink-900)]"
                : value
                  ? "bg-[var(--color-white)] border-[var(--color-blue-200)] hover:border-[var(--color-blue-400)] shadow-[var(--shadow-xs)] text-[var(--color-ink-900)]"
                  : "bg-[var(--color-white)] border-[var(--color-blue-100)] hover:border-[var(--color-blue-300)] shadow-[var(--shadow-xs)] text-[var(--color-ink-400)]",
          ].join(" ")}
        >
          ...
          <span className="shrink-0 flex items-center">
            {loading ? (
              <Loader2
                className="w-4 h-4 animate-spin text-[var(--color-blue-500)]"
            ...
            >
              ...
              <div
                ...
                style={{
                  ...
                  borderBottom: "1px solid var(--color-blue-100)",
                }}
              >
                <div className="relative">
                  {/* Search icon */}
                    ...
                    {search && (
                      <motion.button
                        ...
                        onMouseEnter={(e) => {
                          ...
                          el.style.background = "var(--color-blue-100)";
                    ...
                    return (
                      <button
                        ...
                        className={[
                          ...
                          isSelected
                            ? "bg-[var(--color-blue-50)] text-[var(--color-blue-800)]"
                            : "text-[var(--color-ink-700)] hover:bg-[var(--color-surface-100)] hover:text-[var(--color-blue-700)]",
                        ].join(" ")}
                      >
              ...
              {options.length > 50 && !search && (
                <div
                  ...
                  style={{
                    borderTop: "1px solid var(--color-blue-50)",
