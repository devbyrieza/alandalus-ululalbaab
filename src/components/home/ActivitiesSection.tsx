...
function ActivityCard({
  ...
  return (
    <motion.div
      ...
      className="group flex flex-col bg-white rounded-lg border border-primary-100 shadow-premium-sm overflow-hidden transition-all duration-500 ease-spring hover:-translate-y-2 hover:shadow-premium-md hover:border-primary-200"
    >
      {/* Image */}
      <div className="relative h-52 overflow-hidden shrink-0 bg-primary-50">
        <Image
          src={activity.image}
          alt={activity.name}
          fill
...
function ExtraChip({ item, index }: { item: ExtraActivity; index: number }) {
  ...
  const colorMap = {
    blue: "bg-primary-50 text-primary-600 group-hover:bg-primary-100 ring-primary-200",
    amber: "bg-secondary-50 text-secondary-600 group-hover:bg-secondary-100 ring-secondary-300",
  };

  const textHoverMap = {
    blue: "group-hover:text-primary-800",
    amber: "group-hover:text-secondary-700",
  };
  ...
  return (
    <motion.div
      ...
      className="group flex flex-col items-center justify-center gap-3 p-5 md:p-6 bg-white rounded-lg border border-primary-100 hover:border-primary-200 hover:shadow-premium-sm hover:bg-surface-50 transition-all duration-400 cursor-default"
    >
      <div
        className={[
          "w-12 h-12 md:w-13 md:h-13 rounded-lg flex items-center justify-center shadow-xs",
...
export default function ActivitiesSection() {
  return (
    <section
      id="kegiatan"
      className="section-alt relative border-y border-primary-100/60"
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse, rgba(220,237,255,0.65) 0%, transparent 70%)",
        }}
      />
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse, rgba(254,243,199,0.4) 0%, transparent 70%)",
        }}
      />
      ...
      <Container className="relative z-10">
        ...
        <div className="mb-16 md:mb-20">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-primary-50 border border-primary-100 text-primary-700 text-[0.65rem] font-bold uppercase tracking-[0.12em] mb-5 shadow-xs">
            ...
            <div className="relative p-10 md:p-12 rounded-[2.5rem] bg-primary-900 overflow-hidden shadow-sm border border-gray-200">
              ...
              <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
                <div className="max-w-md">
                  ...
                  <p className="text-primary-100/70 font-medium text-sm leading-relaxed">
