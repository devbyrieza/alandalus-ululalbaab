...
const STATS: Stat[] = [
  {
    ...
    description: "Tahun ke-5 Membangun Generasi" },
  {
    id: "quality",
    ...
    color: "amber",
    suffix: "%",
    sublabel: "Tahfidz, Syar'i, Akademik & Entrepreneurship",
    description: "Empat pilar pendidikan utama" },
  {
    id: "levels",
...
function StatCard({
  ...
  return (
    ...
    >
      <div className="glass-panel relative flex flex-col items-center text-center px-6 py-8 md:px-8 md:py-10 rounded-lg overflow-hidden h-full">
        {/* Hover radial bg */}
        <div
        ...
        <div
          className={[
            "relative mb-6 w-13 h-13 md:w-14 md:h-14 flex items-center justify-center rounded-lg shadow-xs",
            "transition-all duration-500 group-hover:scale-110",
            isBlue ? "bg-primary-50 text-primary-700 group-hover:bg-primary-100" : "",
            isAmber ? "bg-secondary-100 text-primary-700 group-hover:bg-secondary-200" : "",
          ].join(" ")}
        >
          <Icon className="w-5 h-5 md:w-6 md:h-6" strokeWidth={1.75} />
          <div
            className={[
              "absolute inset-0 rounded-lg ring-0 transition-all duration-500",
              isBlue ? "group-hover:ring-2 group-hover:ring-primary-200" : "",
              isAmber ? "group-hover:ring-2 group-hover:ring-secondary-300" : "",
            ].join(" ")}
          />
        </div>
        ...
        <div className="flex items-baseline justify-center gap-0.5 mb-1">
          <span
            className={[
              ...
              isBlue ? "text-primary-700" : "",
              isAmber ? "text-primary-800" : "",
            ].join(" ")}
          >
            <AnimatedCounter
              value={stat.value}
          ...
          {stat.suffix && (
            <span
              className={[
                ...
                isBlue ? "text-primary-500" : "",
                isAmber ? "text-secondary-600" : "",
              ].join(" ")}
            >
              {stat.suffix}
            </span>
        ...
        <div
          className={[
            ...
            isBlue ? "bg-primary-100 group-hover:bg-primary-500" : "",
            isAmber ? "bg-secondary-200 group-hover:bg-primary-300" : "",
          ].join(" ")}
        />
      </div>
    </motion.div>
      ...
      <Container className="relative z-10">
        <div className="max-w-5xl mx-auto space-y-12 md:space-y-14">
          ...
          >
            ...
            {/* Badge 2 — Akreditasi */}
            <div className="section-label section-label-blue border-secondary-200 text-ink-700 bg-secondary-50/50 hover:bg-secondary-100/50 cursor-default">
