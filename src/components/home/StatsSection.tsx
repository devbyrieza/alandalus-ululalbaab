...
const STATS = [
  { id: 'batch', label: 'Angkatan Ke-1', value: 1, icon: Calendar, color: 'blue' as const, suffix: '', sublabel: 'Al-Andalus Ulul Albaab' },
  { id: 'quality', label: 'Standar Global', value: 100, icon: Award, color: 'yellow' as const, suffix: '%', sublabel: 'Kurikulum Internasional' },
  { id: 'levels', label: 'Jenjang Elit', value: 2, icon: GraduationCap, color: 'blue' as const, suffix: '', sublabel: 'MTs · SMA' },
  { id: 'quota', label: 'Kuota Terbatas', value: 30, icon: Users, color: 'yellow' as const, suffix: '', sublabel: 'Santri (Eksklusif)' },
] as const;
        ...
        <div className="max-w-6xl mx-auto">
            ...
            {STATS.map((stat, index) => (
              ...
              >
                <div className={`w-14 h-14 rounded-2xl flex items-center justify-center mb-5 transition-transform duration-500 group-hover:scale-110 shadow-sm
                  ${stat.color === 'blue' ? 'bg-brand-blue-50 text-brand-blue-600' :
                  stat.color === 'yellow' ? 'bg-brand-yellow-100 text-brand-yellow-700' :
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-brand-blue-50/50 rounded-pill border border-brand-blue-100">
              ...
              <span className="text-[10px] font-bold text-ink-700 uppercase tracking-widest">Resmi Ulul Albaab</span>
            </div>
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-brand-blue-50/50 rounded-pill border border-brand-blue-100">
              <TrendingUp className="w-3.5 h-3.5 text-brand-blue-600" />
              <span className="text-[10px] font-bold text-ink-700 uppercase tracking-widest">Modern Digital School</span>
            </div>
          </motion.div>
        </div>
      </Container>
