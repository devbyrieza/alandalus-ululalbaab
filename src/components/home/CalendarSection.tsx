...
export default function CalendarSection() {
  return (
    <section
      id="kalender"
      className="section-std relative border-y border-primary-100 overflow-hidden"
    >
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center lg:items-start">
          ...
          <div className="lg:w-[45%] w-full">
            <motion.div
              ...
              viewport={{ once: true, margin: "-40px" }}
              transition={{ duration: 0.6, ease: EASE }}
              className="bg-white rounded-[2.5rem] p-8 sm:p-10 md:p-12 flex flex-col justify-center items-center text-center relative overflow-hidden shadow-premium-lg border border-primary-100 group hover:border-primary-200 transition-all duration-500"
            >
              <div className="absolute -bottom-24 -right-24 w-64 h-64 bg-secondary-100/50 rounded-full blur-[60px] pointer-events-none transition-transform duration-700 group-hover:scale-110" />
              ...
              <div className="relative z-10 flex flex-col items-center">
                ...
                <div className="space-y-3.5 w-full max-w-[240px]">
                  ...
                  <Link href="#" className="block w-full">
                    <button className="btn-secondary w-full justify-center py-3 bg-white hover:bg-primary-50 border-primary-100 group/btn">
