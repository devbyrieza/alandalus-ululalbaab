...
const FACILITIES = [
    { name: "Masjid Kapasitas 1000 Jamaah", icon: Home, color: "brand-blue" },
    { name: "Gedung Sekolah Terpadu", icon: School, color: "brand-yellow" },
    ...
    { name: "Kantin Sehat", icon: Coffee, color: "brand-yellow" },
] as const;
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 mb-16">
                    {FACILITIES.map((facility, idx) => (
                        <motion.div
                            ...
                            className="flex items-center gap-4 p-4 rounded-2xl bg-white border border-brand-blue-100 group hover:bg-brand-blue-50 hover:border-brand-blue-200 hover:shadow-md transition-all duration-300"
                        >
                            <div className={`w-11 h-11 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center shrink-0 shadow-sm transition-transform duration-500 group-hover:scale-110 ${
                                facility.color === 'brand-blue' ? 'bg-brand-blue-100 text-brand-blue-600' :
                                facility.color === 'brand-yellow' ? 'bg-brand-yellow-100 text-brand-yellow-700' :
                            ...
                            <span className="font-bold text-ink-950 text-sm leading-tight group-hover:text-brand-blue-700 transition-colors">{facility.name}</span>
                        </motion.div>
                    ))}
                </div>
