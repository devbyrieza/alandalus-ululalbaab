...
const iconClasses: Record<string, string> = {
    ...
    yellow: "bg-brand-yellow-100 text-brand-blue-800 ring-brand-yellow-200",
            ...
            <Container className="relative z-10">
                ...
                <div className="text-center mb-14 max-w-2xl mx-auto">
                    <motion.div
                       ...
                       text-brand-blue-700 text-xs font-bold uppercase tracking-widest
                       mb-5 shadow-xs"
                    >
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mb-14 auto-rows-[200px] md:auto-rows-[220px]">
                    {FACILITY_IMAGES.map((img, idx) => (
                        <motion.div
                          ...
                          border border-white/80 ring-1 ring-brand-blue-100
                          shadow-md`}
                        >
                            {/* Image */}
                            <Image
                           ...
                           group-hover:scale-[1.06] bg-brand-blue-50"
                            />
                            ...
                            {/* Yellow accent bar — subtle branding touch */}
                            <div
                                className="absolute top-0 left-0 right-0 h-0.5
                             bg-gradient-to-r from-brand-yellow-400/0
                             via-brand-yellow-400/60 to-brand-yellow-400/0
                ...
                >
                    ...
                    <span className="text-xs font-bold uppercase tracking-widest text-brand-blue-300 whitespace-nowrap px-1">
                        Fasilitas Penunjang
                    </span>
                    <div className="flex-1 h-px bg-gradient-to-r from-transparent via-brand-blue-100 to-transparent" />
                </motion.div>
                ...
                >
                    {FACILITIES.map((facility, idx) => (
                        <motion.div
                         ...
                         bg-white border border-brand-blue-100
                         hover:border-brand-blue-300 hover:shadow-sm
                        ...
                        >
                            ...
                            <span
                               ...
                               group-hover:text-brand-blue-800 transition-colors duration-200"
                            >
                                {facility.name}
                            </span>
                            ...
                            <ChevronRight
                                className="w-3.5 h-3.5 text-brand-blue-300 ml-auto shrink-0
