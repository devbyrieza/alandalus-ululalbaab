          ...
          <div className="flex flex-col gap-7 lg:gap-9 text-center lg:text-left">
            ...
            <motion.div variants={fadeUp} initial="hidden" animate={animate} transition={{ delay: 0.2 }} className="space-y-3">
              <h1
                ...
                style={{ color: "var(--color-brand-blue-800)", fontSize: "clamp(2rem, 5vw + 0.75rem, 5rem)" }}
              >
                <span className="block">Kaderisasi Ummat</span>
                <span
                  className="block mt-1"
                  style={{ background: "linear-gradient(135deg, var(--color-brand-blue-600) 0%, var(--color-brand-yellow-500) 45%, var(--color-brand-blue-700) 100%)", WebkitBackgroundClip: "text", backgroundClip: "text", WebkitTextFillColor: "transparent", paddingBottom: "0.15em" }}
                >
                  Rabbani, Cendekia,{" "}
