...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="glow-blob glow-blob-amber w-[50%] h-[60%] top-[10%] -right-[10%] opacity-15" aria-hidden="true" />
      ...
      <Container className="relative z-10">
        <div className="grid lg:grid-cols-[1.1fr_0.9fr] xl:grid-cols-[1.2fr_0.8fr] gap-12 lg:gap-16 xl:gap-20 items-center">
          ...
          >
            ...
            <div className="glow-blob glow-blob-amber w-48 h-48 -top-10 -left-10 opacity-20" aria-hidden="true" />
          </motion.div>
        </div>
      </Container>
    </section>
