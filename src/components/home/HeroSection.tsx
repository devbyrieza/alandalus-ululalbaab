          ...
          >
            <div className="space-y-4 lg:space-y-6">
              ...
              >
                ...
                <span>Terakreditasi BAN-PDM • Pendidikan Berbasis Karakter & Teknologi</span>
              </motion.div>
              ...
              <p className="text-base lg:text-lg leading-relaxed max-w-2xl mx-auto lg:mx-0 font-medium font-sans text-brand-blue-700/80 text-center lg:text-left">
                Bukan sekadar tempat belajar agama — sistem pembentukan karakter berbasis <span className="font-bold text-brand-blue-800">Lingkungan, Kebiasaan, Komunitas, dan Spiritualitas</span> tanpa kekerasan dan luka pengasuhan.
              </p>
