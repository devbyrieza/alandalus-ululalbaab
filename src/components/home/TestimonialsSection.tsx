...
function TestimonialCard({
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -4 }}
      className="group relative bg-white flex flex-col h-full rounded-2xl border border-blue-100 shadow-premium-sm hover:shadow-premium-md hover:border-blue-200 overflow-hidden transition-all duration-400"
    >
      ...
      <div className="relative z-10 flex flex-col h-full p-6 md:p-7">
        <div className="flex items-center justify-between mb-5">
          <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-blue-50 border border-blue-100 text-[0.6rem] font-black text-blue-700 tracking-wide shadow-xs group-hover:bg-blue-100 transition-all duration-300">
            #{no}
          </span>
          <Quote
            className="w-8 h-8 text-blue-50 -rotate-12 transition-colors duration-400 group-hover:text-blue-100"
            aria-hidden
          />
        </div>
        ...
        <div className="border-t border-blue-50 pt-5">
          <div className="flex items-center gap-3.5">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-600 to-blue-800 flex items-center justify-center shrink-0 text-white font-black text-sm shadow-xs group-hover:-rotate-3 transition-all duration-400">
              {initial}
            </div>
            <div className="min-w-0 flex-1">
              ...
              <p className="text-[0.6rem] font-bold text-blue-600 uppercase tracking-[0.1em] leading-tight mt-0.5">
                {role}
              </p>
            </div>
            <span className="text-[0.575rem] font-black text-blue-600 uppercase tracking-widest bg-blue-50 px-2 py-1 rounded-full border border-blue-100 shadow-xs whitespace-nowrap">
              {date}
            </span>
          </div>
      ...
      <Container className="relative z-10">
        <div className="text-center mb-14 md:mb-16 max-w-2xl mx-auto">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white border border-blue-100 text-blue-700 text-[0.65rem] font-bold uppercase tracking-[0.12em] mb-5 shadow-xs"
          >
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 bg-blue-50 text-blue-800 px-4 py-2 rounded-xl border border-blue-100 font-bold text-[0.8125rem] shadow-xs"
          >
            <span className="text-amber-500">✦</span> Reputasi Global
            yang Teruji
          </motion.div>
        </div>
