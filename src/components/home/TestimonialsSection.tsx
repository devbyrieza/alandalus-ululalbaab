    ...
    >
      ...
      <div className="relative z-10 flex flex-col h-full p-6 md:p-7">
        <div className="flex items-center justify-between mb-5">
          ...
          <Quote
            className="w-8 h-8 text-brand-blue-50 -rotate-12 transition-colors duration-400 group-hover:text-brand-blue-100"
            aria-hidden
          />
        </div>
        ...
        <div className="flex gap-1 mb-4">
          {[...Array(5)].map((_, i) => (
            <Star
              key={i}
              className="w-3.5 h-3.5 text-brand-yellow-500 fill-brand-yellow-500"
              aria-hidden
            />
          ))}
        </div>
        ...
        <div className="border-t border-brand-blue-50 pt-5">
          <div className="flex items-center gap-3.5">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-[0.6rem] font-bold text-brand-blue-600 uppercase tracking-[0.1em] leading-tight mt-0.5">
                {role}
              </p>
            </div>
...
export default function TestimonialsSection() {
  return (
    <section
      id="testimonials"
      className="section-alt relative border-y border-brand-blue-100 overflow-hidden"
    >
      <div
      ...
      <Container className="relative z-10">
        <div className="text-center mb-14 md:mb-16 max-w-2xl mx-auto">
          ...
          >
            Cerita Keberhasilan{" "}
            <span className="text-gradient-blue">Alumni & Wali Santri</span>
          </motion.h2>
          ...
          >
            Ulul Albaab menerapkan standar keunggulan dan sistem yang sama
            dengan Pesantren Al Andalus Pusat (Jonggol) International Islamic
            Boarding School.
          </motion.p>
          ...
          >
            <span className="text-brand-yellow-500">✦</span> Reputasi Global
            yang Teruji
          </motion.div>
        </div>
