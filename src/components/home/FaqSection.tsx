...
const FAQS = [
  {
    ...
    answer:
      "Pendaftaran PPDB Tahun Ajaran 2027/2028 dibuka mulai tanggal 10 September sampai dengan 30 Desember 2026. Namun, pendaftaran dapat ditutup lebih awal jika kuota santri baru sudah terpenuhi." },
  {
