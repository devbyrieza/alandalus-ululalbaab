    ...
    return (
        <section id="faq" className="section-std relative overflow-hidden">
            ...
            <div
                ...
                style={{ background: "radial-gradient(circle, rgba(254,243,199,0.5) 0%, transparent 65%)" }}
            />
            <div
                className="absolute top-10 -right-20 w-[300px] h-[300px] pointer-events-none"
                style={{ background: "radial-gradient(circle, rgba(220,237,255,0.45) 0%, transparent 65%)" }}
            />
            ...
            <Container className="relative z-10">
                ...
                <div className="text-center mb-14 md:mb-16 max-w-2xl mx-auto">
                    ...
                    >
                        ...
                        dan sistem pendidikan di Al Andalus Ulul Albaab.
                    </motion.p>
                </div>
                ...
                >
                    <div className="group relative flex flex-col items-center gap-5 bg-brand-blue-50/60 rounded-2xl p-7 border border-brand-blue-100 text-center overflow-hidden transition-all duration-400 hover:border-brand-blue-200 hover:shadow-premium-sm">
                        ...
                        <div className="relative z-10 w-12 h-12 rounded-xl bg-white flex items-center justify-center shadow-xs border border-brand-blue-100 group-hover:border-brand-blue-200 transition-colors duration-300">
                            <MessageCircleMore className="w-5 h-5 text-brand-blue-500" strokeWidth={1.75} />
                        </div>
