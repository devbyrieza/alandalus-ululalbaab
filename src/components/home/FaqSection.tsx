...
const FAQS = [
  {
    ...
    answer:
      "Pendaftaran PPDB Tahun Ajaran 2026/2027 dibuka mulai tanggal 10 Februari sampai dengan 30 Mei 2026. Namun, pendaftaran dapat ditutup lebih awal jika kuota santri baru sudah terpenuhi.",
  },
  {
    question: "Apakah santri diwajibkan untuk tinggal di asrama?",
    answer:
      "Ya, seluruh santri di Pesantren Al Andalus Ulul Albaab wajib tinggal di asrama untuk mengikuti seluruh rangkaian kegiatan tarbiyah, halaqah tahfidz, dan pembelajaran kitab turots secara maksimal.",
  },
  {
    question:
...
const WA_URL = "https://wa.me/6281285300800";
    ...
    >
      <div
        className={[
          ...
          isOpen
            ? "border-brand-blue-200 shadow-premium-sm ring-1 ring-brand-blue-100/60"
            : "border-brand-blue-100 hover:border-brand-blue-200 hover:shadow-xs",
        ].join(" ")}
      >
        <button
          onClick={toggle}
          className="w-full text-left flex items-center justify-between gap-4 px-6 py-5 md:px-7 md:py-6 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-blue-500 focus-visible:ring-offset-2 rounded-2xl"
          aria-expanded={isOpen}
        >
          <span
            className={[
              "font-bold text-[0.9375rem] md:text-base leading-snug tracking-tight transition-colors duration-200 pr-3",
              isOpen ? "text-brand-blue-700" : "text-ink-900",
            ].join(" ")}
          >
            {question}
          </span>
          ...
          <div
            className={[
              ...
              isOpen
                ? "bg-brand-blue-600 text-white rotate-180"
                : "bg-brand-yellow-50 text-brand-blue-500 hover:bg-brand-blue-50",
            ].join(" ")}
          >
          ...
          {isOpen && (
            ...
            >
              <div className="px-6 pb-6 md:px-7 md:pb-7">
                <div className="h-px w-12 bg-brand-blue-100 mb-5" />
  ...
  return (
    <section id="faq" className="section-std relative overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(220,237,255,0.45) 0%, transparent 65%)",
        }}
      />
      ...
      <Container className="relative z-10">
        <div className="text-center mb-14 md:mb-16 max-w-2xl mx-auto">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-brand-blue-50 border border-brand-blue-100 text-brand-blue-700 text-[0.65rem] font-bold uppercase tracking-[0.12em] mb-5 shadow-xs"
          >
          ...
          >
            ...
            biaya, dan sistem pendidikan di Al Andalus Ulul Albaab.
          </motion.p>
        </div>
        ...
        >
          <div className="group relative flex flex-col items-center gap-5 bg-brand-blue-50/60 rounded-2xl p-7 border border-brand-blue-100 text-center overflow-hidden transition-all duration-400 hover:border-brand-blue-200 hover:shadow-premium-sm">
            <div className="absolute inset-0 bg-gradient-to-b from-transparent to-brand-yellow-50/30 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />

            <div className="relative z-10 w-12 h-12 rounded-xl bg-white flex items-center justify-center shadow-xs border border-brand-blue-100 group-hover:border-brand-blue-200 transition-colors duration-300">
              <MessageCircleMore
