        ...
        <section className="py-16 md:py-24 lg:py-32 bg-white relative overflow-hidden border-y border-brand-yellow-400">
            <Container>
                ...
                >
                    ...
                    <div className="hidden sm:block absolute -bottom-32 -left-32 w-64 h-64 sm:w-80 sm:h-80 md:w-[400px] md:h-[400px] bg-brand-yellow-500/20 rounded-full blur-[80px] md:blur-[100px]" />
                    ...
                    <div className="relative z-10 max-w-3xl mx-auto">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center px-4 max-w-xl mx-auto">
                            <Link href="/ppdb" className="w-full sm:w-auto flex-1">
                                <button className="w-full px-8 py-4 rounded-pill bg-white text-brand-blue-900 font-bold hover:bg-cream-50 transition-all duration-300 shadow-md hover:shadow-lg hover:-translate-y-1 text-base md:text-lg flex items-center justify-center gap-2">
                                    Daftar Sekarang
                                </button>
                            </Link>
