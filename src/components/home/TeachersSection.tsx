          ...
          <div className="lg:w-[58%] grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 w-full">
            {TEACHER_BACKGROUNDS.map((item, idx) => (
              ...
              >
                ...
                <div className="mt-0.5 w-6 h-6 rounded-full bg-secondary-50 border border-secondary-100 flex items-center justify-center shrink-0 shadow-xs transition-transform duration-400 group-hover:scale-110 group-hover:bg-secondary-100">
                  <CheckCircle2
