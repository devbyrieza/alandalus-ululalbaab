        ...
        <div className="flex flex-col lg:flex-row gap-14 lg:gap-24 items-start">
          ...
          >
            ...
            <h2 className="section-title mb-5">
              Dibimbing Oleh{" "}
              <span className="text-gradient-blue">Asatidz Kompeten</span>
            </h2>

            <p className="section-subtitle lg:ml-0 text-justify lg:text-left mb-10 max-w-lg mx-auto lg:mx-0">
              Pesantren Al Andalus Ulul Albaab didukung oleh asatidzah
              profesional lulusan universitas terbaik dunia Islam serta pakar
              pendidikan nasional.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-3 sm:gap-4">
              {[
                ...
                <div
                  key={i}
                  className="group flex items-center gap-4 bg-white p-3.5 rounded-2xl border border-brand-blue-100 shadow-premium-sm hover:shadow-premium-md hover:border-brand-blue-200 transition-all duration-400"
                >
                  <div
                    className={`w-11 h-11 rounded-[12px] flex items-center justify-center shrink-0 shadow-xs transition-transform duration-400 group-hover:scale-105 ${
                      feature.accent === "blue"
                        ...
                        : feature.accent === "yellow"
                          ? "bg-brand-yellow-50 text-brand-yellow-700 border border-brand-yellow-100"
