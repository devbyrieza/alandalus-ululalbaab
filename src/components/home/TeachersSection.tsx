    ...
    >
      ...
      <Container className="relative z-10">
        <div className="flex flex-col lg:flex-row gap-14 lg:gap-24 items-start">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white border border-amber-200 text-blue-700 text-[0.65rem] font-bold uppercase tracking-[0.12em] mb-5 shadow-xs">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-3 sm:gap-4">
              {[
                ...
                <div
                  key={i}
                  className="group flex items-center gap-4 bg-white p-3.5 rounded-2xl border border-blue-100 shadow-premium-sm hover:shadow-premium-md hover:border-blue-200 transition-all duration-400"
                >
                  <div
          ...
          <div className="lg:w-[58%] grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 w-full">
            {TEACHER_BACKGROUNDS.map((item, idx) => (
              <motion.div
                ...
                className="group relative bg-white p-5 rounded-2xl border border-blue-100 shadow-premium-sm hover:shadow-premium-md hover:border-blue-200 flex items-start gap-3.5 overflow-hidden transition-all duration-400"
              >
                ...
                <div className="mt-0.5 w-6 h-6 rounded-full bg-amber-50 border border-amber-100 flex items-center justify-center shrink-0 shadow-xs transition-transform duration-400 group-hover:scale-110 group-hover:bg-amber-100">
                  <CheckCircle2
                ...
                <div className="space-y-1 mt-0.5 relative z-10">
                  <h4 className="font-bold text-ink-900 text-[0.875rem] leading-snug group-hover:text-blue-800 transition-colors duration-200">
                    {item.institution}
                  </h4>
