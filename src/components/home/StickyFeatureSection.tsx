              ...
              return (
                ...
                >
                  <div className="flex items-center gap-4 mb-2">
                    <div className={`w-12 h-12 shrink-0 rounded-lg flex items-center justify-center transition-colors duration-300 ${isActive ? 'bg-primary-500 text-white shadow-primary-md' : 'bg-surface-200 text-ink-400'}`}>
