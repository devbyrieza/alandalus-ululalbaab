...
export default function FeaturesSection() {
  return (
    <section id="keunggulan" className="section-std relative overflow-hidden">
      ...
      <div className="glow-blob glow-blob-blue w-[500px] h-[500px] -top-[15%] -right-[10%] opacity-[0.12]" aria-hidden="true" />
      <div className="glow-blob glow-blob-amber w-[400px] h-[400px] bottom-[5%] left-[5%] opacity-[0.10]" aria-hidden="true" />
      <Container className="relative z-10">
        <div className="flex flex-col lg:flex-row items-start gap-16 lg:gap-24">
          ...
          <div className="lg:w-1/2 lg:sticky lg:top-32">
            ...
            >
              <div>
                ...
                <h2 className="section-title mb-3">Kenapa Harus Ulul Albaab?</h2>
              ...
              <div className="flex flex-col gap-6 pt-2">
                {FEATURES.map((feature, idx) => (
                  <motion.div
                    ...
                    className="bg-white/90 backdrop-blur-sm p-6 rounded-2xl flex gap-5 group items-start border border-brand-blue-50 hover:border-brand-blue-200 hover:shadow-premium-md transition-all duration-400 cursor-default hover:-translate-y-1"
                  >
                    {/* CiroAI Icon Box */}
                    <div className="icon-box icon-box-blue w-14 h-14 rounded-xl shrink-0">
                      <feature.icon className="w-7 h-7" />
                    </div>
                    <div>
                      <h4 className="font-black text-ink-950 text-base mb-1.5 group-hover:text-brand-blue-800 transition-colors tracking-tight">
                        {feature.title}
                      </h4>
          ...
          <div className="lg:w-1/2 relative w-full">
            ...
            >
              <div className="space-y-4 lg:space-y-6 mt-12">
                <div className="app-card p-6 sm:p-8 min-h-56 md:h-64 flex flex-col justify-end items-start group">
                  <p className="text-4xl lg:text-5xl font-black text-brand-blue-900 mb-2 tracking-tighter uppercase">
                    TA 26/27
                  </p>
                  <div className="space-y-1">
                    ...
                    <p className="text-xs leading-tight text-ink-500 font-medium">
                      ...
                      <span className="text-brand-blue-700 font-bold block mt-1">
                ...
                <div className="bg-linear-to-br from-brand-blue-600 via-brand-blue-700 to-brand-blue-900 shine-top border border-white/10 p-6 sm:p-8 rounded-2xl shadow-xl min-h-64 md:h-72 flex flex-col justify-center items-center text-center relative overflow-hidden group hover:shadow-2xl hover:-translate-y-2 transition-all duration-500">
                  {/* CiroAI-style ambient glow inside dark card */}
                  <div className="absolute -top-16 -right-16 w-40 h-40 bg-brand-yellow-400/25 blur-[60px] rounded-full pointer-events-none group-hover:bg-brand-yellow-400/40 transition-colors duration-700" />
                  <div className="absolute -bottom-10 -left-10 w-32 h-32 bg-brand-blue-300/10 blur-[50px] rounded-full pointer-events-none" />

                  <div className="icon-box icon-box-amber w-20 h-20 rounded-2xl mb-6 group-hover:scale-110 transition-transform duration-500">
                  ...
                  <div className="mt-4 w-12 h-0.5 bg-brand-yellow-400/40 rounded-full group-hover:w-16 group-hover:bg-brand-yellow-300 transition-all duration-500" />
                </div>
              </div>

              <div className="space-y-4 lg:space-y-6">
                <div className="app-card p-6 sm:p-8 min-h-64 md:h-72 flex flex-col justify-center items-center text-center group">
                  <div className="w-20 h-20 bg-brand-blue-50 rounded-xl flex items-center justify-center mb-6 shadow-sm group-hover:scale-110 transition-transform duration-500">
                    <ShieldCheck className="w-10 h-10 text-brand-blue-600" />
                  </div>
                  <p className="font-black text-2xl text-brand-blue-900">
                    Lingkungan
                    <br />
                    Islami
                  </p>
                ...
                <div className="bg-brand-blue-50/80 backdrop-blur-lg border border-brand-blue-100 p-6 sm:p-8 rounded-[2rem] shadow-sm min-h-56 md:h-64 flex flex-col justify-end items-start hover:shadow-md transition-all duration-300">
                  <p className="text-4xl font-black mb-1 text-brand-blue-800 tracking-tighter">
                    RESMI
                  </p>
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[80%] h-[80%] rounded-full blur-[120px] z-0 pointer-events-none" style={{ background: "radial-gradient(ellipse, rgba(3,105,199,0.07) 0%, rgba(245,158,11,0.06) 50%, transparent 70%)" }} aria-hidden="true" />
          </div>
        </div>
      </Container>
    </section>
