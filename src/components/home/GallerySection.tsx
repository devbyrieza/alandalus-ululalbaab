...
function GalleryCard({
  ...
  return (
    <motion.div
      ...
      style={{
        boxShadow:
          "0 4px 20px -4px rgba(3,105,199,0.10), 0 2px 8px -2px rgba(0,0,0,0.06)",
      }}
    >
      {/* Image */}
      <div className="relative aspect-[4/3] overflow-hidden">
        ...
        {/* Gradient overlay — biru deep sesuai branding */}
        <div className="absolute inset-0 bg-gradient-to-t from-brand-blue-950/85 via-brand-blue-900/30 to-transparent transition-opacity duration-500 opacity-80 group-hover:opacity-100" />
      ...
      {/* Icon chip — kuning saat hover, signature ululalbaab */}
      <div
        className="absolute top-3.5 right-3.5 w-9 h-9 rounded-xl bg-white/15 backdrop-blur-md flex items-center justify-center border border-white/20 text-white opacity-0 group-hover:opacity-100 transition-all duration-300 group-hover:bg-brand-yellow-400/90 group-hover:border-brand-yellow-300/50 group-hover:text-brand-blue-900"
      ...
      <div className="absolute bottom-0 left-0 right-0 p-5">
        ...
        <p className="text-brand-blue-100/75 text-xs mt-1 font-medium opacity-0 translate-y-3 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 delay-[40ms]">
          {description}
        </p>
      </div>

      {/* Bottom accent line — kuning brand, signature ululalbaab */}
      <div className="absolute bottom-0 left-0 w-0 h-[2.5px] bg-gradient-to-r from-brand-yellow-400 to-brand-yellow-500 group-hover:w-full transition-all duration-500 ease-out" />
    </motion.div>
  );
}
...
function ScheduleCard({
  ...
  return (
    <motion.div
      ...
      className="flex items-center gap-3.5 p-4 rounded-xl bg-white border border-brand-blue-100/70 transition-all duration-300 hover:border-brand-blue-200 hover:shadow-[0_4px_16px_-4px_rgba(3,105,199,0.12)]"
      style={{
        boxShadow:
          "0 1px 4px rgba(3,105,199,0.06), 0 1px 2px rgba(0,0,0,0.04)",
      }}
    >
      <div
    ...
    <section id="gallery" className="section-std !pb-0 overflow-hidden">
      <Container>
        ...
        >
          <div className="max-w-xl">
            <motion.div variants={fadeUpVariants}>
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-brand-blue-50 border border-brand-blue-100 text-brand-blue-700 text-[11px] font-bold uppercase tracking-[0.12em] mb-4 shadow-sm">
            ...
            <motion.h2 variants={fadeUpVariants} className="section-title mb-0">
              Galeri{" "}
              <span className="text-gradient-blue">Aktivitas</span>
            </motion.h2>
        ...
        <motion.div
          ...
          className="relative rounded-t-[2.5rem] overflow-hidden border border-b-0 border-brand-blue-100"
          style={{
            background:
              "linear-gradient(160deg, #EFF7FF 0%, #FFFFFF 55%, #FFFBEB 100%)",
            boxShadow: "0 -12px 40px -12px rgba(3,105,199,0.07)",
          }}
        >
          {/* Decorative blobs — biru & kuning khas ululalbaab */}
          <div
            className="pointer-events-none absolute -top-32 -right-32 w-80 h-80 rounded-full"
            style={{
              background:
                "radial-gradient(circle, rgba(3,105,199,0.05) 0%, transparent 70%)",
            }}
          />
          <div
          ...
          {/* Accent line atas — kuning brand, signature ululalbaab */}
          <div className="absolute top-0 left-0 right-0 h-[3px] bg-gradient-to-r from-brand-yellow-400 via-brand-yellow-300 to-transparent" />
          ...
          <div className="relative z-10 grid lg:grid-cols-[1fr_1.1fr] gap-8 lg:gap-12 items-center p-8 md:p-12 max-w-6xl mx-auto">
            ...
            >
              <motion.div variants={fadeUpVariants}>
                <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-brand-yellow-50 border border-brand-yellow-200 text-brand-yellow-700 text-[11px] font-bold uppercase tracking-[0.10em] mb-4">
              ...
              <motion.h3
                variants={fadeUpVariants}
                className="font-black text-brand-blue-900 tracking-tight mb-3"
                style={{
