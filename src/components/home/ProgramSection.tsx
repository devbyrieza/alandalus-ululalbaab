                            ...
                            <div className="app-card bg-white p-8 md:p-10 h-full flex flex-col group">
                                ...
                                <div className="flex items-start justify-between mb-8">
                                    <div className={`w-14 h-14 rounded-2xl flex items-center justify-center shadow-sm ${
                                        program.color === 'brand-blue' ? 'bg-brand-blue-100 text-brand-blue-600' : 'bg-brand-yellow-100 text-brand-yellow-700'
                                        }`}>
                                    ...
                                    <ul className="space-y-4 mb-10">
                                        {program.features.map((feature, fIdx) => (
                                            <li key={fIdx} className="flex items-start gap-3">
                                                <div className="mt-1 w-5 h-5 rounded-full bg-brand-blue-100 flex items-center justify-center flex-shrink-0">
