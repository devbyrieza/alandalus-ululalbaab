    ...
    switch (variant) {
        case "blue":
            return {
                ...
                ctaBtn: "bg-white border-brand-blue-200 text-brand-blue-800 hover:bg-brand-blue-700 hover:border-brand-blue-700 hover:text-white shadow-sm hover:shadow-md",
            };
        case "yellow":
            return {
                ...
                ctaBtn: "bg-white border-brand-yellow-300 text-brand-blue-800 hover:bg-brand-yellow-400 hover:border-brand-yellow-400 hover:text-brand-blue-950 shadow-sm hover:shadow-md",
            };
        case "teal":
            return {
                ...
                ctaBtn: "bg-white border-brand-blue-200 text-brand-blue-800 hover:bg-brand-blue-800 hover:border-brand-blue-800 hover:text-white shadow-sm hover:shadow-md",
            };
    }
}
...
export default function ProgramSection() {
    return (
        <section id="program" className="section-alt relative overflow-hidden border-y border-brand-blue-100">
            ...
            <Container className="relative z-10">
                <div className="max-w-2xl mx-auto text-center mb-14 md:mb-16">
                    ...
                    >
                        Program Studi <span className="text-gradient-blue">Unggulan ✨</span>
                    </motion.h2>
                                            ...
                                            {program.quotaLabel ? (
                                                <div className="flex flex-col items-end gap-1">
                                                    ...
                                                    <div className="flex items-center gap-1.5 bg-ink-950 text-white px-2.5 py-1 rounded-[8px] shadow-sm">
                                                        ...
                                                        <span className="text-[0.65rem] font-black">{program.quotaLabel}</span>
                                                    </div>
                                                </div>
                                            ) : (
                                                <div className="flex flex-col items-end gap-1">
                                                    <span className="text-[0.6rem] font-bold text-ink-400 uppercase tracking-[0.15em]">Syarat Khusus</span>
                                                    <div className="flex items-center gap-1.5 bg-brand-yellow-400 text-brand-blue-950 px-2.5 py-1 rounded-[8px] shadow-sm">
                                                        <span className="text-[0.65rem] font-black">Seleksi</span>
                                                    </div>
                                                </div>
                                            )}
                                        </div>
