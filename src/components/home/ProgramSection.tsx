...
type ProgramVariant = "blue" | "amber" | "pink";
  ...
  switch (variant) {
    case "blue":
      return {
        ...
        ctaBtn:
          "bg-white border-primary-200 text-primary-800 hover:bg-primary-700 hover:border-primary-700 hover:text-white shadow-sm hover:shadow-sm" };
    case "amber":
      return {
