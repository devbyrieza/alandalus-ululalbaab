  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="flex items-center gap-2 px-3 py-1.5 rounded-full border border-slate-200 bg-white hover:border-blue-300 hover:bg-blue-50/30 transition-all duration-300 group"
      >
            ...
            >
              ...
              <div className="mt-2 pt-2 border-t border-slate-50">
                <button
                  ...
                  className="w-full text-center py-2 text-[10px] font-bold text-slate-400 hover:text-blue-600 transition-colors uppercase tracking-widest"
                >
                  Bahasa Lainnya...
                </button>
              </div>
