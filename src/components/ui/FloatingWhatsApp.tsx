  ...
  return (
    <div className="fixed bottom-6 right-5 sm:right-6 z-50 flex flex-col items-end gap-3">
      ...
      <motion.a
        ...
        style={{ background: "linear-gradient(135deg, #25D366 0%, #128C7E 100%)", boxShadow: "0 4px 20px rgba(37, 211, 102, 0.45), 0 2px 8px rgba(0,0,0,0.12)" }}
      >
        <span className="absolute inset-0 rounded-full animate-ping opacity-25" style={{ backgroundColor: "#25D366" }} aria-hidden />
        <span className="absolute inset-[-6px] rounded-full animate-ping opacity-15" style={{ backgroundColor: "#25D366", animationDelay: "0.4s", animationDuration: "2s" }} aria-hidden />
