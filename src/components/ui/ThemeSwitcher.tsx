  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-2 p-2 sm:p-2.5 rounded-lg bg-surface-50 border border-surface-200 text-ink-700 hover:bg-surface-100 transition-all duration-300 min-h-[40px] border-none !bg-transparent sm:!bg-surface-50 sm:border-solid lg:hover:shadow-premium-sm relative z-[71]"
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="absolute right-0 mt-2 w-40 bg-white dark:bg-ink-900 rounded-lg shadow-premium-xl border border-surface-200 dark:border-white/10 p-1.5 z-[70] overflow-hidden"
