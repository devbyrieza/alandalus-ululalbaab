...
const FALLBACK_ACTIVITIES = [
  { name: "Ibrahim W.", city: "Bandung", program: "Tahfizh" },
  { name: "Luqman H.", city: "Bekasi", program: "SMP IT" },
  { name: "Fatih M.", city: "Cianjur", program: "SMA IT" }
];
    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="fixed bottom-6 left-3 sm:left-6 z-50 bg-white rounded-lg shadow-premium-xl border border-surface-100 px-4 py-3 flex items-center gap-3 max-w-[min(260px,calc(100vw-4.5rem))]"
        >
          <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-green-50 to-green-100 shadow-inner border border-green-200/50 flex items-center justify-center shrink-0">
