...
export default function ChatSystem() {
  ...
  const openWhatsApp = () => {
    ...
    const waMessage = encodeURIComponent(
      "Halo Panitia PPDB Pesantren Ulul Albaab, saya ingin bertanya...",
    );
              ...
              <div className="space-y-1">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h4 className="font-bold text-ink-900 group-hover:text-blue-800 text-sm mb-0.5">
                      ?? Tanya AI Assistant
                    </h4>
                ...
                {/* 
                                ...
                                >
                                    <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center shrink-0 group-hover:bg-blue-600 transition-colors">
                                        <Headphones className="w-5 h-5 text-blue-600 group-hover:text-white transition-colors" />
                                    </div>
                                    <div>
                                        <h4 className="font-bold text-ink-900 group-hover:text-blue-800 text-sm mb-0.5">?? Live Chat CS</h4>
          ...
          <AnimatePresence>
            {!isAiOpen && (
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="w-[60px] h-[60px] md:w-16 md:h-16 bg-blue-700 text-white rounded-[1.2rem] md:rounded-[1.3rem] flex items-center justify-center shadow-[0_10px_30px_rgba(30,58,138,0.4)] relative transition-all duration-300"
              >
                {/* Pulse Effect */}
                <span
                  className="absolute inset-0 rounded-[1.2rem] md:rounded-[1.3rem] bg-blue-700/40 animate-ping"
                  style={{ animationDuration: "3s" }}
                />

                <div className="relative z-10 w-full h-full flex items-center justify-center bg-blue-700 rounded-[1.2rem] md:rounded-[1.3rem] border-2 border-blue-600/50">
                  {isMenuOpen ? (
