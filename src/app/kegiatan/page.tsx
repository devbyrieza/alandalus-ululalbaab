...
const FeatureCard = ({
  ...
  >
    ...
    <div className={`relative ${index % 2 === 1 ? "lg:col-start-2" : ""}`}>
      <div
        className={`aspect-[4/3] max-h-[480px] min-h-[300px] w-full rounded-[3.5rem] overflow-hidden shadow-sm relative group ${index % 2 === 0 ? "rotate-2" : "-rotate-2"} hover:rotate-0 transition-transform duration-700 border border-primary-100 p-4 bg-white`}
      >
      ...
      {/* Program Badge */}
      <div className="absolute -top-4 -right-4 bg-white px-6 py-3 rounded-pill shadow-sm border border-primary-100 z-10 flex items-center gap-2">
    ...
    <div className="flex flex-col justify-center">
      <div
        className={`w-16 h-16 ${item.bgColor} rounded-lg flex items-center justify-center shadow-sm mb-8 transition-transform hover:scale-110`}
      >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-10">
        {item.stats.map((stat, statIdx) => (
          <div
            key={statIdx}
            className="bg-primary-50 p-6 sm:p-8 rounded-[1.5rem] border border-primary-100 text-center hover:bg-white hover:shadow-sm transition-all"
          >
...
const StatsCard = ({ icon: Icon, value, label, sublabel }: HeroStat) => (
  <motion.div
    whileHover={{ y: -5 }}
    className="app-card bg-white p-6 sm:p-8 md:p-6 rounded-[2rem] md:rounded-[2.5rem] border border-primary-100 shadow-sm text-center min-w-[140px] md:min-w-[160px] flex flex-col items-center"
  >
...
const ScheduleCard = ({
  ...
  <motion.div
    ...
    className={`group p-10 rounded-[3rem] ${schedule.bgColor} border border-primary-100 shadow-sm hover:shadow-sm transition-all duration-500 hover:-translate-y-2`}
  >
    <div className="flex flex-col h-full">
      <div className="flex items-center justify-between mb-8">
        <div className="w-16 h-16 bg-white rounded-lg flex items-center justify-center shadow-sm group-hover:scale-110 transition-transform border border-primary-100">
      ...
      <div className="mt-auto inline-flex items-center gap-3 bg-white/60 p-6 sm:p-8 rounded-lg border border-primary-100 shadow-sm">
...
const WeeklyActivityCard = ({
  ...
  <motion.div
    ...
    className={`app-card group p-8 rounded-[2.5rem] bg-white border border-primary-50 shadow-sm hover:shadow-sm transition-all hover:-translate-y-2 text-center`}
  >
    <div
...
const EkskulCard = ({
  ...
  <motion.div
    ...
    viewport={{ once: true }}
    transition={{ delay: index * 0.05 }}
    className="app-card group p-6 sm:p-8 md:p-8 rounded-[2rem] md:rounded-[2.5rem] bg-white border border-primary-50 shadow-sm hover:shadow-sm hover:border-primary-200 transition-all hover:-translate-y-2 text-center h-full flex flex-col justify-between"
  >
...
export default function KegiatanPage() {
  ...
  const ekstrakurikuler: Ekstrakurikuler[] = [
      ...
      benefit: "Jiwa Entrepreneur" },
    {
      name: "Kewirausahaan",
      icon: Zap,
      desc: "Praktik dasar bisnis syariah, manajemen usaha, dan mental kemandirian entrepreneur muslim.",
      benefit: "Jiwa Entrepreneur" },
  ];
          ...
          >
            ...
            <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 w-full">
              {[
                ...
                >
                  <div className="w-12 h-12 md:w-14 md:h-14 rounded-lg bg-primary-50 shadow-sm flex items-center justify-center text-primary-600 shrink-0 group-hover:bg-primary-600 group-hover:text-white transition-colors border border-primary-100">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-6 justify-center px-4">
                <Link href="/ppdb">
                  <button className="w-full sm:w-auto px-6 md:px-10 py-3.5 sm:py-4 md:py-5 rounded-pill bg-white text-primary-900 font-black text-sm sm:text-base md:text-lg hover:bg-primary-50 shadow-sm transition-all min-h-[48px] sm:min-h-[52px]">
                    Daftar Sekarang
                  </button>
                </Link>
                <Link href="/kontak">
