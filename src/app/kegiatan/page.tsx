...
const FeatureCard = ({
  ...
  >
    ...
    <div className={`relative ${index % 2 === 1 ? "lg:col-start-2" : ""}`}>
      <div
        className={`aspect-[4/3] max-h-[480px] min-h-[300px] w-full rounded-[3.5rem] overflow-hidden shadow-sm border border-gray-200 relative group ${index % 2 === 0 ? "rotate-2" : "-rotate-2"} hover:rotate-0 transition-transform duration-700 border border-primary-100 p-4 bg-white`}
      >
      ...
      {/* Program Badge */}
      <div className="absolute -top-4 -right-4 bg-white px-6 py-3 rounded-pill shadow-sm border border-gray-200 border border-primary-100 z-10 flex items-center gap-2">
    ...
    <div className="flex flex-col justify-center">
      <div
        className={`w-16 h-16 ${item.bgColor} rounded-lg flex items-center justify-center shadow-sm border border-gray-200 mb-8 transition-transform hover:scale-110`}
      >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-10">
        {item.stats.map((stat, statIdx) => (
          <div
            key={statIdx}
            className="bg-primary-50 p-6 sm:p-8 rounded-[1.5rem] border border-primary-100 text-center hover:bg-white hover:shadow-sm border border-gray-200 transition-all"
          >
      ...
      {/* Results List */}
      <div className="app-card bg-white p-5 md:p-8 rounded-[2.5rem] border border-primary-100 shadow-sm border border-gray-200 mb-8">
...
const StatsCard = ({ icon: Icon, value, label, sublabel }: HeroStat) => (
  <motion.div
    whileHover={{ y: -5 }}
    className="app-card bg-white p-6 sm:p-8 md:p-6 rounded-[2rem] md:rounded-[2.5rem] border border-primary-100 shadow-sm border border-gray-200 text-center min-w-[140px] md:min-w-[160px] flex flex-col items-center"
  >
    <div className="w-10 h-10 md:w-12 md:h-12 rounded-lg md:rounded-lg bg-primary-50 flex items-center justify-center text-primary-600 mb-3 md:mb-4 border border-primary-100">
...
const ScheduleCard = ({
  ...
  <motion.div
    ...
    className={`group p-10 rounded-[3rem] ${schedule.bgColor} border border-primary-100 shadow-sm border border-gray-200 hover:shadow-sm border border-gray-200 transition-all duration-500 hover:-translate-y-2`}
  >
    <div className="flex flex-col h-full">
      <div className="flex items-center justify-between mb-8">
        <div className="w-16 h-16 bg-white rounded-lg flex items-center justify-center shadow-sm border border-gray-200 group-hover:scale-110 transition-transform border border-primary-100">
      ...
      <div className="mt-auto inline-flex items-center gap-3 bg-white/60 p-6 sm:p-8 rounded-lg border border-primary-100 shadow-sm border border-gray-200">
...
const WeeklyActivityCard = ({
  ...
  <motion.div
    ...
    className={`app-card group p-8 rounded-[2.5rem] bg-white border border-primary-50 shadow-sm border border-gray-200 hover:shadow-sm border border-gray-200 transition-all hover:-translate-y-2 text-center`}
  >
    <div
      className={`w-14 h-14 ${activity.bg} rounded-lg flex items-center justify-center ${activity.color} mx-auto mb-6 group-hover:scale-110 transition-transform border border-primary-100`}
    >
...
const EkskulCard = ({
  ...
  <motion.div
    ...
    viewport={{ once: true }}
    transition={{ delay: index * 0.05 }}
    className="app-card group p-6 sm:p-8 md:p-8 rounded-[2rem] md:rounded-[2.5rem] bg-white border border-primary-50 shadow-sm border border-gray-200 hover:shadow-sm border border-gray-200 hover:border-primary-200 transition-all hover:-translate-y-2 text-center h-full flex flex-col justify-between"
  >
    <div className="w-12 h-12 md:w-16 md:h-16 bg-primary-50 rounded-lg md:rounded-lg flex items-center justify-center text-primary-600 mx-auto mb-4 md:mb-6 group-hover:scale-110 transition-all duration-300 border border-primary-100">
      ...
      <section className="relative py-24 md:py-32 overflow-hidden bg-white">
        ...
        <Container className="relative z-10 text-center">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-pill bg-primary-50 border border-primary-100 text-primary-700 text-xs font-bold uppercase tracking-widest mb-10 shadow-sm border border-gray-200"
          >
          ...
          >
            ...
            <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 w-full">
              {[
                ...
                >
                  <div className="w-12 h-12 md:w-14 md:h-14 rounded-lg bg-primary-50 shadow-sm border border-gray-200 flex items-center justify-center text-primary-600 shrink-0 group-hover:bg-primary-600 group-hover:text-white transition-colors border border-primary-100">
      ...
      <section className="py-16 md:py-24 lg:py-32 bg-white">
        <Container>
          <motion.div
            ...
            whileInView={{ opacity: 1, scale: 1 }}
            viewport={{ once: true }}
            className="bg-primary-900 bg-linear-to-br from-primary-800 to-primary-950 rounded-[2rem] md:rounded-[3rem] lg:rounded-[4rem] p-6 sm:p-5 md:p-8 lg:p-24 text-center text-white relative overflow-hidden shadow-sm border border-gray-200"
          >
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-6 justify-center px-4">
                <Link href="/ppdb">
                  <button className="w-full sm:w-auto px-6 md:px-10 py-3.5 sm:py-4 md:py-5 rounded-pill bg-white text-primary-900 font-black text-sm sm:text-base md:text-lg hover:bg-primary-50 shadow-sm border border-gray-200 transition-all min-h-[48px] sm:min-h-[52px]">
                    Daftar Sekarang
                  </button>
                </Link>
                <Link href="/kontak">
