  ...
  return (
    <div className="app-card max-w-md w-full bg-white rounded-[2.5rem] shadow-lg border border-brand-blue-100 p-8 relative z-10">
      ...
      <div className="text-center mb-6 relative z-10">
        ...
        {!sim_code && (
          <p className="text-lg font-black text-brand-blue-700">{no_hp}</p>
        )}
        ...
        {sim_code && (
          <div className="mt-4 p-3 bg-brand-yellow-50 border border-brand-yellow-200 rounded-xl app-card shadow-sm">
            <p className="text-xs font-black uppercase tracking-widest text-brand-blue-800 mb-1">
              Kode Verifikasi Anda
            </p>
            <p className="text-sm text-brand-blue-950 font-medium">
              Masukkan kode berikut:{" "}
              <span className="font-mono text-xl font-black bg-white px-2 py-0.5 rounded-lg border border-brand-yellow-100 shadow-sm ml-2">
                {sim_code}
              </span>
            </p>
      ...
      <div className="text-center mb-6 relative z-10">
        {countdown > 0 ? (
          <p className="text-sm text-ink-600 font-medium flex items-center justify-center gap-2">
            ...
            Kode berlaku selama{" "}
            <strong className="text-brand-blue-700 font-black">
      ...
      <div className="mt-6 p-4 bg-brand-blue-50 border border-brand-blue-100 rounded-[1.5rem] relative z-10 app-card shadow-sm">
        ...
        <ul className="text-xs text-ink-600 space-y-1.5 font-medium pl-1">
          <li className="flex gap-2">
            <span className="text-brand-blue-500 opacity-50">•</span> Pastikan
            nomor HP Anda aktif dan terdaftar di WhatsApp
          </li>
          <li className="flex gap-2">
            <span className="text-brand-blue-500 opacity-50">•</span> Kode
            otomatis terverifikasi setelah 6 digit terisi
          </li>
          <li className="flex gap-2">
            <span className="text-brand-blue-500 opacity-50">•</span> Jika tidak
