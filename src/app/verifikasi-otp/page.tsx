...
function VerifikasiOTPContent() {
  ...
  return (
    <div className="app-card max-w-md w-full bg-white rounded-[2.5rem] shadow-sm border border-primary-100 p-5 md:p-8 relative z-10">
      ...
      <div className="mt-6 p-4 bg-primary-50 border border-primary-100 rounded-[1.5rem] relative z-10 app-card shadow-sm">
        ...
        <ul className="text-xs text-ink-600 space-y-1.5 font-medium pl-1">
          <li className="flex gap-2">
            <span className="text-primary-500 opacity-50">•</span> Pastikan
            nomor HP Anda aktif dan terdaftar di WhatsApp
          </li>
          <li className="flex gap-2">
            <span className="text-primary-500 opacity-50">•</span> Kode
...
function LoadingFallback() {
  return (
    <div className="app-card max-w-md w-full bg-white rounded-[2.5rem] shadow-sm border border-primary-100 p-5 md:p-8">
