...
export async function POST(request: NextRequest) {
  try {
    ...
    if (santri?.jenis_kelamin === "Laki-laki" || santri?.jenis_kelamin === "L") jenisKelaminDb = "L";
    else if (santri?.jenis_kelamin === "Perempuan" || santri?.jenis_kelamin === "P") jenisKelaminDb = "P";
