...
export async function GET(
  ...
  try {
    ...
    const mergedPendaftar = {
      ...
      alamat:
        pendaftar.alamat && pendaftar.alamat !== "-"
          ? pendaftar.alamat
          : santri.alamat || null,
      ...
      asal_sekolah:
        pendaftar.asal_sekolah && pendaftar.asal_sekolah !== "-"
          ? pendaftar.asal_sekolah
          : santri.asal_sekolah || null,
      ...
      jumlah_saudara:
        ...
        (santri.berapa_bersaudara
          ? parseInt(santri.berapa_bersaudara)
          : santri.jumlah_saudara
            ? parseInt(santri.jumlah_saudara)
            : null),
      no_hp:
        pendaftar.no_hp && pendaftar.no_hp !== "-"
          ? pendaftar.no_hp
          : santri.no_hp || null,
...
export async function PATCH(
  ...
  try {
    ...
    if (!status_proses) {
      return NextResponse.json(
        { error: "status_proses or no_hp is required" },
        { status: 400 },
      );
    }
