        ...
        >
          <Container>
            ...
            >
              ...
              <div className="w-20 h-1.5 bg-amber-400 rounded-pill" />
            </motion.div>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-6 justify-center px-4">
                <Link href="/kontak">
                  <button className="w-full sm:w-auto px-6 sm:px-10 py-3.5 sm:py-4 md:py-5 rounded-pill bg-white text-blue-950 font-black text-sm sm:text-base md:text-lg hover:bg-blue-50 shadow-md transition-all min-h-[48px] sm:min-h-[52px]">
                    Jadwalkan Kunjungan
                  </button>
                </Link>
                <Link href="/ppdb">
                  <button className="w-full sm:w-auto px-10 py-3.5 sm:py-4 md:py-5 rounded-pill bg-white/10 text-white font-bold border border-white/20 hover:bg-white/20 transition-all flex items-center justify-center gap-2 sm:gap-3 text-sm sm:text-base md:text-lg min-h-[48px] sm:min-h-[52px]">
                    Info PPDB
                  </button>
                </Link>
              </div>
