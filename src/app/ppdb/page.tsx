        ...
        <Container className="relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <motion.div
              ...
              className="max-w-4xl mx-auto bg-maroon-50 border border-maroon-200 rounded-3xl p-6 md:p-8 mb-12 flex flex-col md:flex-row items-center gap-6 text-left shadow-premium-sm"
            >
      ...
      <section className="py-16 md:py-24 lg:py-32 bg-white">
        <Container>
          <motion.div
            ...
            whileInView={{ opacity: 1, scale: 1 }}
            viewport={{ once: true }}
            className="bg-maroon-800 bg-linear-to-br from-brown-800 to-brown-950 rounded-[2rem] md:rounded-[3rem] lg:rounded-[4rem] p-6 sm:p-8 md:p-16 lg:p-24 text-center text-white relative overflow-hidden shadow-premium-2xl"
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-sm sm:text-base md:text-lg lg:text-xl text-brown-100 max-w-2xl mx-auto mb-6 sm:mb-8 md:mb-10 lg:mb-12 font-medium leading-relaxed px-2">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-6 justify-center px-4">
                <Link href="/daftar">
                  <span className="w-full sm:w-auto inline-block px-6 sm:px-8 py-3.5 sm:py-4 md:py-5 rounded-pill bg-white text-brown-900 font-black text-sm sm:text-base md:text-lg xl:text-xl hover:bg-gold-400 hover:text-white shadow-premium-xl transition-all cursor-pointer min-h-[48px] sm:min-h-[52px]">
                    Daftar Sekarang
                  </span>
                </Link>
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-white">
      <motion.div
        ...
        className="w-12 h-12 text-brown-600 mb-4"
      >
