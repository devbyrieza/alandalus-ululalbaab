...
const PROGRAMS = [
    {
        ...
        description: "Memadukan tahfizh Al-Qur'an, kurikulum pendidikan nasional, kurikulum khas pesantren berbasis Kitab Turots, dan entrepreneurship. Semua dengan bahasa pengantar Bahasa Arab.",
        stats: [
                                ...
                                <div className={idx % 2 === 1 ? 'lg:col-start-1' : ''}>
                                    ...
                                    >
                                        ...
                                        <h3 className="text-2xl font-black text-ink-950 mb-8 flex items-center gap-3">
                                            <div className={`w-3 h-10 rounded-full ${program.theme === 'blue' ? 'bg-brand-blue-600' : 'bg-brand-yellow-500'}`} />
                                            Kurikulum & Fokus
                                        </h3>
