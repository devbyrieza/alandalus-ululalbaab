...
const HeroStat = ({
  ...
  >
    <div className="w-12 h-12 rounded-xl bg-blue-50 flex items-center justify-center text-blue-600 mb-3 border border-blue-100 shadow-sm">
      <Icon className="w-6 h-6" />
    </div>
    <p className="text-2xl font-black text-blue-950 leading-none mb-1">
      {value}
    </p>
    <p className="text-[10px] text-blue-500/70 font-extrabold uppercase tracking-widest">
      {label}
    </p>
  </motion.div>
);
...
Saya ingin mengajukan Jadwal Kunjungan ke Pesantren Ulul Albaab.
  ...
  return (
    <main className="bg-white min-h-screen">
      ...
      <section className="relative py-24 md:py-32 overflow-hidden section-std">
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-blue-50/60 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/2 pointer-events-none" />
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="space-y-6 pt-12">
                <div className="aspect-4/5 rounded-[3rem] overflow-hidden shadow-lg relative group border border-blue-100">
                  <Image
                ...
                <div className="aspect-square rounded-[3rem] overflow-hidden shadow-lg relative group border border-blue-100">
                  <Image
              ...
              {/* Floating Badge */}
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white p-5 rounded-[2rem] shadow-xl border border-blue-100 flex flex-col items-center gap-1 z-20">
      ...
      <section className="py-24 md:py-32 relative section-alt border-y border-blue-100">
        <Container>
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
              ...
              >
                <div className="app-card bg-white p-8 sm:p-12 lg:p-16 relative overflow-hidden group hover:-translate-y-1 transition-transform duration-500">
                  ...
                  <div className="w-16 h-16 sm:w-20 sm:h-20 bg-blue-50 rounded-2xl flex items-center justify-center text-blue-700 mb-8 sm:mb-10 shadow-sm transition-transform group-hover:scale-110 border border-blue-100">
                    <Home className="w-8 h-8 sm:w-10 sm:h-10" />
                  </div>

                  <h3 className="text-3xl sm:text-4xl lg:text-5xl font-black text-blue-950 mb-6 leading-[1.1]">
                    Masjid Jami' <br className="hidden sm:block" /> Ulul Albaab
                  </h3>
                  <p className="text-base sm:text-lg lg:text-xl text-blue-950/70 mb-8 sm:mb-10 leading-relaxed font-medium">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8">
                    <div className="flex items-start gap-4 group/item">
                      ...
                      <div>
                        <h4 className="font-black text-blue-950 text-[15px] sm:text-lg uppercase tracking-tight">
                          Kapasitas Luas
                        </h4>
              ...
              >
                <div className="aspect-square rounded-[3rem] sm:rounded-[4rem] bg-white p-3 sm:p-4 shadow-xl relative rotate-2 hover:rotate-0 transition-transform duration-700 border border-blue-100">
        ...
        <Container>
          <div className="text-center max-w-3xl mx-auto mb-16">
            <motion.h2
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="text-3xl md:text-5xl font-black text-blue-950 mb-4"
            >
              Fasilitas <span className="text-blue-600">Penunjang</span>
            </motion.h2>
            <motion.p
              initial={{ opacity: 0, y: 10 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="text-base md:text-lg text-blue-950/70 font-medium leading-relaxed"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6 max-w-5xl mx-auto">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ delay: 0.1 }}
              className="app-card bg-white p-6 md:p-8 flex flex-col items-start group hover:-translate-y-1 transition-transform border border-blue-50 shadow-sm"
            >
              <div className="w-12 h-12 bg-blue-50 rounded-xl flex items-center justify-center text-blue-700 mb-5 group-hover:scale-110 transition-transform border border-blue-100 shadow-sm">
                <BookOpen className="w-6 h-6" />
              </div>
              <h3 className="font-black text-lg text-blue-950 mb-2">
                Perpustakaan
              </h3>
              <p className="text-sm text-blue-950/60 font-medium">
                Ribuan koleksi kitab & buku
              </p>
              <div className="mt-4 pt-4 border-t border-blue-50 w-full">
      ...
      <section
        id="visit"
        className="py-24 md:py-32 section-alt border-y border-blue-100 relative overflow-hidden"
      >
        {/* Background decoration */}
        <div className="absolute top-0 left-0 w-64 h-64 bg-blue-50 rounded-full blur-[100px] -translate-x-1/2 -translate-y-1/2 opacity-60" />
            ...
            <div className="grid lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-5">
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-pill bg-white border border-blue-100 text-blue-700 text-xs font-bold uppercase tracking-widest mb-6 shadow-sm">
                  ...
                  <h2 className="text-4xl md:text-5xl font-display font-black text-ink-950 mb-6 leading-tight">
                    Kunjungi <span className="text-gradient-blue">Kami</span>
                  </h2>
                  <p className="text-lg text-ink-600 mb-8 leading-relaxed font-medium">
                    Masih banyak fasilitas pendukung lainnya di dalam Pesantren Ulul Albaab.
                  ...
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    transition={{ delay: 0.2 }}
                    className="mt-10 bg-white p-2.5 rounded-[2rem] border border-blue-100 shadow-lg shadow-blue-900/5 overflow-hidden relative group"
                  >
                    <div className="rounded-[1.5rem] overflow-hidden h-[200px] relative bg-blue-50">
                      <iframe
                        ...
                        title="Lokasi Pesantren Ulul Albaab"
                        className="grayscale group-hover:grayscale-0 transition-all duration-700 opacity-80 group-hover:opacity-100"
                      />
                      <div className="absolute bottom-3 left-3 bg-white/90 backdrop-blur-sm px-4 py-2 rounded-xl shadow-sm border border-blue-100 flex items-center gap-2 z-10 pointer-events-none">
              ...
              <div className="lg:col-span-7">
                <motion.div
                  ...
                  whileInView={{ opacity: 1, x: 0 }}
                  viewport={{ once: true }}
                  className="app-card bg-white p-6 sm:p-10 border border-blue-50 shadow-2xl relative overflow-hidden"
                >
                  {formStatus === 'success' ? (
                    <motion.div 
                    ...
                    >
                      ...
                      <button 
                        ...
                        className="px-6 py-3 rounded-xl bg-blue-50 text-blue-700 font-bold hover:bg-blue-100 transition-colors"
                      >
                        Isi Form Kembali
                      </button>
                    </motion.div>
                    ...
                    <form onSubmit={handleVisitSubmit} className="space-y-6">
                      <div className="grid sm:grid-cols-2 gap-6">
                        <div className="space-y-2">
                          ...
                          <input 
                            ...
                            className="w-full px-4 py-3.5 rounded-xl border border-ink-100 bg-surface-50 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-hidden transition-all font-medium text-ink-900 placeholder:text-ink-300" 
                        ...
                        <div className="space-y-2">
                          <label className="text-sm font-black text-ink-950 flex items-center gap-2">
                            <Smartphone className="w-4 h-4 text-blue-600" /> Nomor WhatsApp
                          </label>
                          <input 
                            required 
                            type="tel" 
                      ...
                      <div className="grid sm:grid-cols-2 gap-6">
                        <div className="space-y-2">
                          <label className="text-sm font-black text-ink-950 flex items-center gap-2">
                            <Calendar className="w-4 h-4 text-blue-600" /> Rencana Tanggal
                          </label>
                          <input 
                            required 
                            type="date" 
                            className="w-full px-4 py-3.5 rounded-xl border border-ink-100 bg-surface-50 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-hidden transition-all font-medium text-ink-900" 
                        ...
                        <div className="space-y-2">
                          <label className="text-sm font-black text-ink-950 flex items-center gap-2">
                            <Clock className="w-4 h-4 text-blue-600" /> Rencana Jam
                          </label>
                          <select 
                            required 
                            className="w-full px-4 py-3.5 rounded-xl border border-ink-100 bg-surface-50 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-hidden transition-all font-medium text-ink-900 cursor-pointer"
                            value={visitForm.jam}
                      ...
                      <div className="space-y-2">
                        <label className="text-sm font-black text-ink-950 flex items-center gap-2">
                          <Users className="w-4 h-4 text-blue-600" /> Jumlah Orang yang Datang
                        </label>
                        <input 
                          required 
                          type="number" 
                      ...
                      <button type="submit" className="w-full py-4 rounded-xl bg-blue-600 text-white font-black text-lg shadow-lg shadow-blue-600/20 hover:bg-blue-700 hover:-translate-y-0.5 hover:shadow-xl transition-all flex items-center justify-center gap-2 mt-2">
