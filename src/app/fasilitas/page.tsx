...
const HeroStat = ({
  ...
  >
    <div className="w-12 h-12 rounded-lg bg-primary-50 flex items-center justify-center text-primary-600 mb-3 border border-primary-100 shadow-sm">
        ...
        <Container className="relative z-10">
          <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              {/* Floating Badge */}
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white p-5 rounded-[2rem] shadow-sm border border-primary-100 flex flex-col items-center gap-1 z-20">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
              ...
              >
                <div className="app-card bg-white p-5 md:p-8 sm:p-6 lg:p-16 relative overflow-hidden group hover:-translate-y-1 transition-transform duration-500">
                  ...
                  <div className="w-16 h-16 sm:w-20 sm:h-20 bg-primary-50 rounded-lg flex items-center justify-center text-primary-700 mb-8 sm:mb-10 shadow-sm transition-transform group-hover:scale-110 border border-primary-100">
      ...
      <section className="py-24 md:py-32 bg-white">
        <Container>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6 max-w-5xl mx-auto">
            ...
            >
              <div className="w-12 h-12 bg-primary-50 rounded-lg flex items-center justify-center text-primary-700 mb-5 group-hover:scale-110 transition-transform border border-primary-100 shadow-sm">
            ...
            <div className="grid lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-5">
                ...
                >
                  ...
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    transition={{ delay: 0.2 }}
                    className="mt-10 bg-white p-4.5 rounded-[2rem] border border-primary-100 shadow-sm shadow-primary-900/5 overflow-hidden relative group"
                  >
              ...
              <div className="lg:col-span-7">
                <motion.div
                  ...
                  whileInView={{ opacity: 1, x: 0 }}
                  viewport={{ once: true }}
                  className="app-card bg-white p-6 sm:p-6 md:p-10 border border-primary-50 shadow-sm relative overflow-hidden"
                >
                  {formStatus === 'success' ? (
                    <motion.div 
                    ...
                    >
                      <div className="w-20 h-20 rounded-full bg-green-50 text-[#550000] flex items-center justify-center mb-6 border border-green-100 shadow-sm">
                    ...
                    <form onSubmit={handleVisitSubmit} className="space-y-6">
                      ...
                      <button type="submit" className="w-full py-4 rounded-lg bg-primary-600 text-white font-black text-lg shadow-sm shadow-primary-600/20 hover:bg-primary-700 hover:-translate-y-0.5 hover:shadow-sm transition-all flex items-center justify-center gap-2 mt-2">
