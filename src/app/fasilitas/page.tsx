              ...
              >
                <div className="app-card bg-white p-8 sm:p-12 lg:p-16 relative overflow-hidden group hover:-translate-y-1 transition-transform duration-500">
                  ...
                  <p className="text-base sm:text-lg lg:text-xl text-brand-blue-950/70 mb-8 sm:mb-10 leading-relaxed font-medium">
                    Pusat peribadatan santri yang mampu menampung{" "}
                    <strong>900 jamaah</strong>. Dilengkapi pendingin ruangan,
                    karpet premium, dan sistem audio berkualitas tinggi.
                  </p>
      ...
      >
        <Container>
          <div className="text-center md:text-left max-w-3xl mb-12 sm:mb-16">
            ...
            >
              Lihat langsung suasana dan lingkungan Pesantren Al Andalus Ulul
              Albaab dari berbagai sudut.
            </motion.p>
          </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-sm font-medium text-ink-700">
                Masih banyak fasilitas pendukung lainnya di dalam Pesantren Al
                Andalus Ulul Albaab. Silakan jadwalkan kunjungan untuk melihat
                langsung.
              </p>
            </motion.div>
          </div>
