...
export default function FasilitasPage() {
  ...
  return (
    <main className="bg-white min-h-screen">
      ...
      <section
        id="visit"
        className="py-24 md:py-32 section-alt border-y border-brand-blue-100 relative overflow-hidden"
      >
        {/* Background decoration */}
        <div className="absolute top-0 left-0 w-64 h-64 bg-brand-blue-50 rounded-full blur-[100px] -translate-x-1/2 -translate-y-1/2 opacity-60" />
            ...
            <div className="grid lg:grid-cols-12 gap-12 items-center">
                ...
                >
                  ...
                  <div className="space-y-6">
                    <div className="flex gap-4">
                      <div className="w-12 h-12 rounded-2xl bg-brand-blue-50 flex items-center justify-center text-brand-blue-600 shrink-0 border border-brand-blue-100">
                  ...
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    transition={{ delay: 0.2 }}
                    className="mt-10 bg-white p-2.5 rounded-[2rem] border border-brand-blue-100 shadow-lg shadow-brand-blue-900/5 overflow-hidden relative group"
                  >
                    <div className="rounded-[1.5rem] overflow-hidden h-[200px] relative bg-brand-blue-50">
                      <iframe
                      ...
                      />
                      <div className="absolute bottom-3 left-3 bg-white/90 backdrop-blur-sm px-4 py-2 rounded-xl shadow-sm border border-brand-blue-100 flex items-center gap-2 z-10 pointer-events-none">
              ...
              <div className="lg:col-span-7">
                <motion.div
                  ...
                  whileInView={{ opacity: 1, x: 0 }}
                  viewport={{ once: true }}
                  className="app-card bg-white p-6 sm:p-10 border border-brand-blue-50 shadow-2xl relative overflow-hidden"
                >
                  {formStatus === 'success' ? (
                    <motion.div 
                    ...
                    >
                      ...
                      <button 
                        ...
                        className="px-6 py-3 rounded-xl bg-brand-blue-50 text-brand-blue-700 font-bold hover:bg-brand-blue-100 transition-colors"
                      >
                        Isi Form Kembali
                      </button>
                    </motion.div>
                    ...
                    <form onSubmit={(e) => { e.preventDefault(); setFormStatus('success'); }} className="space-y-6">
                      <div className="grid sm:grid-cols-2 gap-6">
                        <div className="space-y-2">
                          <label className="text-sm font-black text-ink-950 flex items-center gap-2">
                            <User className="w-4 h-4 text-brand-blue-600" /> Nama Lengkap
                          </label>
                          <input required type="text" placeholder="Contoh: Bapak Ahmad" className="w-full px-4 py-3.5 rounded-xl border border-ink-100 bg-surface-50 focus:bg-white focus:border-brand-blue-500 focus:ring-4 focus:ring-brand-blue-500/10 outline-hidden transition-all font-medium text-ink-900 placeholder:text-ink-300" />
                        </div>
                        <div className="space-y-2">
                          <label className="text-sm font-black text-ink-950 flex items-center gap-2">
                            <Smartphone className="w-4 h-4 text-brand-blue-600" /> Nomor WhatsApp
                          </label>
                          <input required type="tel" placeholder="Contoh: 0812..." className="w-full px-4 py-3.5 rounded-xl border border-ink-100 bg-surface-50 focus:bg-white focus:border-brand-blue-500 focus:ring-4 focus:ring-brand-blue-500/10 outline-hidden transition-all font-medium text-ink-900 placeholder:text-ink-300" />
                        </div>
                      </div>
                      ...
                      <div className="grid sm:grid-cols-2 gap-6">
                        <div className="space-y-2">
                          <label className="text-sm font-black text-ink-950 flex items-center gap-2">
                            <Calendar className="w-4 h-4 text-brand-blue-600" /> Rencana Tanggal
                          </label>
                          <input required type="date" className="w-full px-4 py-3.5 rounded-xl border border-ink-100 bg-surface-50 focus:bg-white focus:border-brand-blue-500 focus:ring-4 focus:ring-brand-blue-500/10 outline-hidden transition-all font-medium text-ink-900" />
                        </div>
                        <div className="space-y-2">
                          <label className="text-sm font-black text-ink-950 flex items-center gap-2">
                            <Clock className="w-4 h-4 text-brand-blue-600" /> Rencana Jam
                          </label>
                          <select required className="w-full px-4 py-3.5 rounded-xl border border-ink-100 bg-surface-50 focus:bg-white focus:border-brand-blue-500 focus:ring-4 focus:ring-brand-blue-500/10 outline-hidden transition-all font-medium text-ink-900 cursor-pointer">
                      ...
                      <div className="space-y-2">
                        <label className="text-sm font-black text-ink-950 flex items-center gap-2">
                          <Users className="w-4 h-4 text-brand-blue-600" /> Jumlah Orang yang Datang
                        </label>
                        <input required type="number" min="1" placeholder="Contoh: 3" className="w-full px-4 py-3.5 rounded-xl border border-ink-100 bg-surface-50 focus:bg-white focus:border-brand-blue-500 focus:ring-4 focus:ring-brand-blue-500/10 outline-hidden transition-all font-medium text-ink-900 placeholder:text-ink-300" />
                      </div>

                      <button type="submit" className="w-full py-4 rounded-xl bg-brand-blue-600 text-white font-black text-lg shadow-lg shadow-brand-blue-600/20 hover:bg-brand-blue-700 hover:-translate-y-0.5 hover:shadow-xl transition-all flex items-center justify-center gap-2 mt-2">
