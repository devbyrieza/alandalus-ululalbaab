        ...
        {isEditing ? (
          <div className="space-y-5 sm:space-y-6">
            ...
            <div className="flex flex-col-reverse sm:flex-row gap-3 pt-4 border-t border-teal-100/60">
              ...
              <button onClick={() => saveForm(p, "hafalan")} disabled={isInputtedByAdmin || !!saving || !hafalanForm.score_override || !hafalanForm.rekomendasi} className="px-6 py-4 rounded-lg sm:rounded-lg font-black text-xs uppercase tracking-widest bg-teal-600 text-white hover:bg-teal-700 transition-all shadow-sm border border-gray-200 shadow-teal-900/20 disabled:opacity-50 disabled:cursor-not-allowed flex-1 text-center flex justify-center items-center gap-2">
        ...
        {!isEditing && (
          <div className="flex justify-end mt-4">
            {(!isSaved || !getLockInfo(p.input_at_hafalan).isLocked) ? (
              <button onClick={() => startEditing(p, "hafalan")} className="px-5 md:px-8 py-3.5 sm:py-4 bg-teal-600 text-white rounded-lg sm:rounded-lg text-[10px] sm:text-xs font-black uppercase tracking-widest hover:bg-teal-700 transition-all shadow-sm border border-gray-200 shadow-teal-900/20 active:scale-95 leading-none">
        ...
        {!isEditing && (
          <div className="flex justify-end mt-4">
            {(!isSaved || !getLockInfo(p.input_at_lisan_arab).isLocked) ? (
              <button onClick={() => startEditing(p, "lisan_arab")} className="px-5 md:px-8 py-3.5 sm:py-4 bg-sky-600 text-white rounded-lg sm:rounded-lg text-[10px] sm:text-xs font-black uppercase tracking-widest hover:bg-sky-700 transition-all shadow-sm border border-gray-200 shadow-sky-900/20 active:scale-95 leading-none">
        ...
        {isEditing ? (
          <div className="space-y-5 sm:space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-2">
              ...
              <button onClick={() => saveForm(p, "quran")} disabled={isInputtedByAdmin || !quranForm.tajwid || !quranForm.kelancaran || !quranForm.rekomendasi || !quranForm.nama_penguji || saving === p.id + "quran"} className="w-full sm:w-auto px-5 md:px-8 py-4 bg-emerald-600 text-white rounded-lg sm:rounded-lg font-black uppercase tracking-widest text-[10px] sm:text-xs hover:bg-emerald-700 transition-all shadow-sm border border-gray-200 shadow-emerald-900/20 disabled:opacity-50 flex items-center justify-center gap-2 active:scale-95">
          ...
          <div>
            ...
            {(!isSaved || !getLockInfo(p.input_at_quran).isLocked) ? (
              <button onClick={() => startEditing(p, "quran")} className="mt-5 sm:mt-6 px-5 md:px-8 py-4 bg-emerald-600 text-white rounded-lg sm:rounded-lg text-[10px] sm:text-xs font-black uppercase tracking-widest hover:bg-emerald-700 transition-all shadow-sm border border-gray-200 shadow-emerald-900/20 active:scale-95 leading-none">
        ...
        {isEditing ? (
          <div className="space-y-5 sm:space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-2">
              ...
              <button onClick={() => saveForm(p, "wawancara")} disabled={isInputtedByAdmin || !criteria.every((c) => calsanForm[c.key]) || !calsanForm.rekomendasi || !calsanForm.nama_pewawancara || saving === p.id + "wawancara"} className="w-full sm:w-auto px-5 md:px-8 py-4 bg-primary-700 text-white rounded-lg sm:rounded-lg font-black uppercase tracking-widest text-[10px] sm:text-xs hover:bg-primary-800 transition-all shadow-sm border border-gray-200 shadow-primary-900/20 disabled:opacity-50 flex items-center justify-center gap-2 active:scale-95">
          ...
          <div>
            ...
            {(!isSaved || !getLockInfo(p.input_at_santri).isLocked) ? (
              <button onClick={() => startEditing(p, "wawancara")} className="mt-5 sm:mt-6 px-5 md:px-8 py-4 bg-primary-700 text-white rounded-lg sm:rounded-lg text-[10px] sm:text-xs font-black uppercase tracking-widest hover:bg-primary-800 transition-all shadow-sm border border-gray-200 shadow-primary-900/20 active:scale-95 leading-none">
                {isSaved ? "Edit Nilai" : "Input Nilai"}
              </button>
            ) : (
              <div className="mt-5 sm:mt-6 inline-flex items-center gap-2 px-6 py-3.5 bg-stone-100 text-stone-400 rounded-lg sm:rounded-lg text-[10px] sm:text-xs font-black uppercase tracking-widest border border-stone-200">
        ...
        {isEditing ? (
          ...
          <div>
            ...
            {(!isSaved || !getLockInfo(p.input_at_ortu).isLocked) ? (
              <button onClick={() => startEditing(p, "ortu")} className="mt-5 sm:mt-6 px-5 md:px-8 py-4 bg-secondary-400 text-primary-950 rounded-lg sm:rounded-lg text-[10px] sm:text-xs font-black uppercase tracking-widest hover:bg-secondary-500 transition-all shadow-sm border border-gray-200 shadow-secondary-400/20 active:scale-95 leading-none">
