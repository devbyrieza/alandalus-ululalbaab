        ...
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-8 space-y-16">
            ...
            <motion.div
              ...
              className={`p-5 sm:p-8 md:p-10 lg:p-12 rounded-[2rem] sm:rounded-[3rem] md:rounded-[4rem] border-2 shadow-2xl relative overflow-hidden bg-gradient-to-br from-white to-ink-50/30 ${statusInfo.border}`}
            >
          ...
          <aside className="lg:col-span-4 space-y-10">
            ...
            <motion.div
              ...
              className="bg-white p-6 sm:p-5 md:p-8 md:p-10 lg:p-6 md:p-12 rounded-[2rem] sm:rounded-[3rem] md:rounded-[4rem] shadow-2xl shadow-primary-900/5 border border-ink-50 flex flex-col items-center text-center relative overflow-hidden group"
            >
            ...
            <motion.div
              ...
              className="bg-primary-950 p-6 sm:p-5 md:p-8 md:p-10 lg:p-6 md:p-12 rounded-[2rem] sm:rounded-[3rem] md:rounded-[4rem] shadow-2xl relative overflow-hidden group"
            >
