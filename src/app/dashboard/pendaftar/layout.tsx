      ...
      <div className="min-h-screen bg-surface-50 font-sans selection:bg-primary-100 selection:text-primary-900 w-full">
        ...
        <div className="flex relative">
          ...
          >
            ...
            />
            <div ref={mobileSidebarRef} className={`absolute top-0 left-0 bottom-0 w-80 bg-white shadow-sm transition-transform duration-300 transform ${sidebarOpen ? "translate-x-0" : "-translate-x-full"}`}
            >
