        ...
        <div className="lg:hidden bg-white/90 backdrop-blur-xl sticky top-0 z-40 px-4 sm:px-5 py-3 sm:py-4 flex items-center justify-between border-b border-brand-yellow-200 shadow-sm">
          <div className="flex items-center gap-2 sm:gap-3">
            <button
              ...
              className="p-2 -ml-2 text-brand-blue-950 hover:bg-brand-yellow-50 rounded-xl transition-colors"
            >
            ...
            <div className="flex flex-col">
              ...
              <span className="text-sm sm:text-base font-black text-brand-blue-950 leading-none">
                Portal Santri
              </span>
            </div>
          </div>
        ...
        <div className="flex relative">
            ...
            <div className="flex flex-col h-full bg-white/70 backdrop-blur-xl border-r border-white/50 shadow-clay-lg">
              ...
              <div className="px-6 pt-8 pb-6 border-b border-brand-yellow-100/50 mb-2">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h1 className="font-black text-xl text-brand-blue-950 leading-none tracking-tight">
                      PPDB{" "}
                ...
                {/* User Card */}
                <div className="p-4 rounded-[1.5rem] bg-brand-yellow-50/50 border border-brand-yellow-100 relative overflow-hidden group app-card">
                  <div className="absolute top-0 right-0 p-2 opacity-5 group-hover:opacity-10 transition-opacity">
                    <User className="w-20 h-20 text-brand-blue-900 translate-x-4 -translate-y-4" />
                  </div>
                  ...
                  <div className="text-[10px] text-ink-500 bg-white px-2.5 py-1.5 rounded-xl inline-flex shadow-sm border border-brand-yellow-100 items-center justify-between w-full">
                    <span className="font-bold uppercase">No. Registrasi</span>
                    <span className="font-mono text-brand-blue-700 font-black">
                      {nomorPendaftaran}
                    </span>
                  </div>
                </div>
              ...
              <div className="flex flex-col h-full overflow-hidden">
                <div className="p-6 border-b border-surface-100 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-black text-lg text-brand-blue-950 tracking-tight">
                      PPDB {BRANDING.schoolName}
                    </span>
                  </div>
                  <button
                    onClick={() => setSidebarOpen(false)}
                    className="p-2 text-ink-400 hover:text-brand-blue-700 bg-brand-yellow-50 rounded-full"
                  >
                    <X className="w-5 h-5" />
                  </button>
                </div>

                <div className="p-5 bg-brand-yellow-50 border-b border-brand-yellow-100">
                  ...
                  <p className="font-mono text-xs font-bold text-brand-blue-700 bg-white px-2 py-1 rounded-lg inline-block border border-brand-yellow-100">
                    {nomorPendaftaran}
                  </p>
                </div>
          ...
          <main className="flex-1 lg:pl-72 w-full transition-all duration-300 flex flex-col min-h-screen relative pb-24 lg:pb-0">
            ...
            <header className="hidden lg:flex sticky top-4 z-30 mx-8 mt-4 rounded-[1.5rem] bg-white/70 backdrop-blur-xl px-6 py-4 items-center justify-between shadow-sm border border-brand-yellow-100">
              <div>
                <h2 className="text-xl font-black text-brand-blue-950 tracking-tight">
                  Dashboard Pendaftar
                </h2>
              ...
              <div className="flex items-center gap-4">
                <Link
                  href="/"
                  className="p-2 text-ink-400 hover:text-brand-blue-700 bg-brand-yellow-50 hover:bg-brand-yellow-100 rounded-full transition-colors"
                  title="Ke Beranda Website"
                >
                  <Home className="w-5 h-5" />
                </Link>

                <div className="h-8 w-px bg-brand-yellow-200" />
            ...
            {!pathname.includes("/ujian/") && (
              <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-brand-yellow-200 pb-safe z-40 shadow-[0_-10px_40px_-10px_rgba(0,0,0,0.1)] rounded-t-[1.5rem]">
                <div className="flex justify-around items-center px-4 py-3">
                  ...
                  >
                    <div
                      className={`w-10 h-8 rounded-full flex items-center justify-center mb-1 transition-colors ${pathname === "/dashboard/pendaftar" ? "bg-brand-yellow-100" : "bg-transparent group-hover:bg-brand-yellow-50"}`}
                    >
                      <Home
                        className={`w-5 h-5 transition-colors ${pathname === "/dashboard/pendaftar" ? "text-brand-blue-700" : "text-ink-400 group-hover:text-brand-blue-600"}`}
                      />
                    </div>
                    <span
                      className={`text-[10px] font-bold text-center ${pathname === "/dashboard/pendaftar" ? "text-brand-blue-800" : "text-ink-400"}`}
                    >
                      Beranda
                    </span>
                  </Link>
                  ...
                  >
                    <div
                      className={`w-10 h-8 rounded-full flex items-center justify-center mb-1 transition-colors ${pathname.includes("pembayaran") ? "bg-brand-yellow-100" : "bg-transparent group-hover:bg-brand-yellow-50"}`}
                    >
                      <CreditCard
                        className={`w-5 h-5 transition-colors ${pathname.includes("pembayaran") ? "text-brand-blue-700" : "text-ink-400 group-hover:text-brand-blue-600"}`}
                      />
                    </div>
                    <span
                      className={`text-[10px] font-bold text-center ${pathname.includes("pembayaran") ? "text-brand-blue-800" : "text-ink-400"}`}
                    >
                      Bayar
                    </span>
                  </Link>
                  ...
                  >
                    <div
                      className={`w-10 h-8 rounded-full flex items-center justify-center mb-1 transition-colors ${pathname.includes("isi-data-lengkap") || pathname.includes("upload-berkas") ? "bg-brand-yellow-100" : "bg-transparent group-hover:bg-brand-yellow-50"}`}
                    >
                      <ClipboardList
                        className={`w-5 h-5 transition-colors ${pathname.includes("isi-data-lengkap") || pathname.includes("upload-berkas") ? "text-brand-blue-700" : "text-ink-400 group-hover:text-brand-blue-600"}`}
                      />
                    </div>
                    <span
                      className={`text-[10px] font-bold text-center ${pathname.includes("isi-data-lengkap") || pathname.includes("upload-berkas") ? "text-brand-blue-800" : "text-ink-400"}`}
                    >
                      Data
                    </span>
                  </Link>
