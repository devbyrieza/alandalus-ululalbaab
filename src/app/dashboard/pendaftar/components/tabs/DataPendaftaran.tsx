  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between">
          ...
          <div className="mt-4 md:mt-0">
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-3 bg-white text-primary-800 font-bold rounded-lg hover:bg-primary-50 transition-all"
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-lg p-4 border-2 border-stone-200 shadow-sm">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 bg-primary-100 rounded-lg flex items-center justify-center whitespace-nowrap shrink-0">
        ...
        <div className="bg-white rounded-lg p-4 border-2 border-stone-200 shadow-sm">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 bg-purple-100 rounded-lg flex items-center justify-center whitespace-nowrap shrink-0">
      ...
      {/* Data Diri Card */}
      <div className="bg-white rounded-lg p-6 border-2 border-stone-200 shadow-sm">
            ...
            <div className="flex items-center justify-between">
              <div className="flex-1">
                ...
                <p className="text-sm text-stone-600">
                  Bayar biaya pendaftaran Rp 250.000
                </p>
              </div>
