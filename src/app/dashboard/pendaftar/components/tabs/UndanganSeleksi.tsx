...
export default function UndanganSeleksiTab() {
        ...
        <div className="bg-amber-50 border-2 border-amber-200 rounded-3xl p-8 md:p-12 text-center shadow-sm">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <Link
              ...
              className="px-8 py-3 bg-blue-700 text-white font-black rounded-xl hover:bg-blue-800 transition-all shadow-md uppercase tracking-widest text-sm"
            >
              Cek Status Berkas
            </Link>
          </div>
  ...
  return (
    <div className="space-y-6">
      {/* ========== HEADER ========== */}
      <div className="bg-linear-to-r from-blue-700 to-blue-900 rounded-2xl p-6 md:p-8 text-white shadow-lg relative overflow-hidden">
        <div className="relative z-10">
      ...
      <div className="bg-white rounded-xl border border-stone-200 p-5 shadow-sm">
        ...
        <div className="w-full h-3 bg-surface-100 rounded-full overflow-hidden">
          <div
            className="h-full bg-linear-to-r from-blue-500 to-blue-700 rounded-full transition-all duration-700 shadow-lg shadow-blue-500/20"
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  <div
                    className={`w-10 h-10 rounded-xl flex items-center justify-center ${
                      item.completed ? "bg-emerald-100" : "bg-blue-50"
                    }`}
                  >
                    <Icon
                      className={`w-5 h-5 ${
                  ...
                  {item.completed ? (
                    ...
                    <span className="px-2.5 py-1 bg-blue-100 text-blue-700 text-xs font-black rounded-full">
                      Tersedia
                    </span>
                  )}
                </div>
                ...
                {item.completed ? (
                  ...
                  <Link
                    ...
                    className="inline-flex items-center gap-2 mt-2 px-4 py-2 bg-amber-400 hover:bg-amber-300 text-blue-950 text-xs font-black rounded-lg transition-colors shadow-sm border border-amber-500"
                  >
                    Mulai Tes
                  </Link>
                )}
              ...
              {data.grupB.booked
                ...
                .map((item) => {
                  ...
                  return (
                    <div
                      key={item.id}
                    className="bg-white rounded-xl shadow-sm p-5 border-2 border-blue-100 relative overflow-hidden"
                  >
                    <div className="absolute top-0 right-0 p-2 bg-blue-50 rounded-bl-xl">
                      ...
                      <div
                        ...
                        className={`bg-white rounded-xl shadow-sm p-5 border-2 transition-all ${
                          slot.isFull
                            ...
                            : "border-surface-100 hover:border-blue-300 hover:shadow-md"
                        }`}
                      >
                        ...
                        <button
                          ...
                          className="w-full py-2.5 bg-amber-400 hover:bg-amber-300 text-blue-950 font-black rounded-lg disabled:bg-surface-200 disabled:text-ink-400 disabled:cursor-not-allowed transition-all shadow-sm flex justify-center items-center gap-2 text-sm border border-amber-500"
                        >
                          {bookingId === slot.id && (
