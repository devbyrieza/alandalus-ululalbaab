...
export default function WelcomeDayPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      {/* ─── HERO BANNER ─── */}
      <div className="relative bg-gradient-to-br from-primary-800 via-primary-900 to-primary-950 p-6 md:p-8 rounded-lg overflow-hidden text-white shadow-sm border border-gray-200">
        {/* Decorative circles */}
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-2xl md:text-3xl font-black leading-tight mb-2 text-white drop-shadow-sm border border-gray-200">
      ...
      <div className="grid grid-cols-1 gap-4">
        ...
        >
          <div className="w-10 h-10 rounded-lg bg-emerald-100 text-emerald-600 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
        ...
        {isEditing ? (
                  ...
                  <button
                    ...
                    className={`p-5 rounded-lg border-2 text-left transition-all duration-300 flex items-center gap-4 group ${
                      formData.statusKehadiran === "HADIR"
                        ? "bg-gradient-to-br from-emerald-500 to-emerald-600 border-emerald-500 text-white shadow-sm border border-gray-200 shadow-emerald-500/25 scale-[1.02]"
                        : "bg-white border-ink-200 hover:border-emerald-300 hover:shadow-sm border border-gray-200 hover:bg-emerald-50/30"
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`p-5 rounded-lg border-2 text-left transition-all duration-300 flex items-center gap-4 group ${
                      formData.statusKehadiran === "TIDAK_HADIR"
                        ? "bg-gradient-to-br from-rose-500 to-rose-600 border-rose-500 text-white shadow-sm border border-gray-200 shadow-rose-500/25 scale-[1.02]"
                        : "bg-white border-ink-200 hover:border-rose-300 hover:shadow-sm border border-gray-200 hover:bg-rose-50/30"
                    }`}
                  >
          ...
          <div className="p-6 space-y-5">
            ...
            {formData.statusKehadiran === "HADIR" && formData.jumlahMobil === 0 && formData.jumlahMotor === 0 && (
              <div className="bg-gradient-to-br from-orange-500 to-amber-500 text-white p-5 rounded-lg shadow-sm border border-gray-200 shadow-orange-500/25 flex flex-col md:flex-row items-center md:items-start justify-between gap-4 mt-6">
      ...
      <div className="bg-gradient-to-r from-primary-50 to-primary-100 border border-primary-200 rounded-lg p-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-3 bg-white rounded-lg p-3 border border-primary-200 hover:shadow-sm border border-gray-200 transition-shadow"
          >
      ...
      {lightbox && (
        ...
        >
          ...
          <a 
            ...
            className="mt-6 flex items-center gap-2 bg-emerald-600 text-white px-6 py-3 rounded-full font-bold hover:bg-emerald-500 transition-colors shadow-sm border border-gray-200 active:scale-95"
          >
