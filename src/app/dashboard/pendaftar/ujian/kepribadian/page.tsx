...
export default function KepribadianTestPage() {
      ...
      <div className="max-w-lg mx-auto p-8 text-center mt-10">
        <div className="bg-white rounded-2xl shadow-lg border p-10">
          ...
          <button
            ...
            className="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl transition-colors shadow-lg shadow-blue-100"
          >
      ...
      <div className="max-w-lg mx-auto p-8 text-center mt-10">
        <div className="bg-white rounded-[2rem] shadow-xl border p-10">
          ...
          <button
            ...
            className="w-full px-6 py-4 bg-blue-700 hover:bg-blue-800 text-white font-black rounded-xl transition-all shadow-md uppercase tracking-widest text-sm"
          >
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-6 pb-24">
      ...
      <div className="bg-linear-to-r from-blue-600 to-blue-800 rounded-xl p-6 mb-6">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
        <div className="flex gap-4">
          <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center border border-blue-100 flex-shrink-0">
      ...
      <div className="bg-white rounded-xl border p-4 mb-6 shadow-sm mt-6">
        ...
        <div className="w-full h-2 bg-stone-100 rounded-full overflow-hidden">
          <div
            className="h-full bg-linear-to-r from-blue-500 to-blue-700 rounded-full transition-all duration-500 shadow-sm shadow-blue-200"
            style={{
          ...
          <div key={q.id} className="bg-white p-5 rounded-xl border shadow-sm">
            ...
            <div className="grid grid-cols-1 gap-3">
              <div
                ...
                className={`cursor-pointer p-5 border-2 rounded-2xl transition-all duration-300 ${answers[q.id] === "A" ? "bg-blue-50 border-blue-500 text-blue-950 shadow-md ring-4 ring-blue-500/5" : "border-stone-100 hover:border-blue-200 hover:bg-slate-50"}`}
              >
                <span
                  className={`font-black mr-3 border rounded-lg px-2.5 py-1 text-xs transition-colors ${answers[q.id] === "A" ? "bg-blue-600 text-white border-blue-600" : "bg-white text-stone-400 border-stone-200"}`}
                >
                  A
                </span>
              ...
              <div
                ...
                className={`cursor-pointer p-5 border-2 rounded-2xl transition-all duration-300 ${answers[q.id] === "B" ? "bg-blue-50 border-blue-500 text-blue-950 shadow-md ring-4 ring-blue-500/5" : "border-stone-100 hover:border-blue-200 hover:bg-slate-50"}`}
              >
                <span
                  className={`font-black mr-3 border rounded-lg px-2.5 py-1 text-xs transition-colors ${answers[q.id] === "B" ? "bg-blue-600 text-white border-blue-600" : "bg-white text-stone-400 border-stone-200"}`}
                >
                  B
                </span>
                <span className="font-bold text-sm sm:text-base">
      ...
      <div className="sticky bottom-4 z-50 flex gap-3">
        ...
        {page < totalPages - 1 ? (
          <button
            onClick={handleNext}
            className="flex-1 py-4 bg-blue-600 hover:bg-blue-700 text-white font-black uppercase tracking-widest text-sm rounded-2xl shadow-xl shadow-blue-200 transition-all active:scale-95"
          >
            Lanjutkan
          </button>
        ) : (
          <button
            ...
            disabled={loading}
            className="flex-1 py-4 bg-blue-600 hover:bg-blue-700 disabled:bg-stone-300 text-white font-black uppercase tracking-widest text-sm rounded-2xl shadow-xl shadow-blue-200 transition-all active:scale-95 flex items-center justify-center gap-2"
          >
            {loading ? (
              <>
