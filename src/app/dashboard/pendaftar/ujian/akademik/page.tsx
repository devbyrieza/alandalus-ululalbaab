  ...
  if (!started) {
    return (
      <div className="max-w-3xl mx-auto p-4 md:p-6">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-[2rem] p-8 mb-8 text-white relative overflow-hidden shadow-lg border border-blue-500">
          ...
          <div className="relative z-10 text-center md:text-left">
            ...
            <p className="text-blue-100 font-medium text-sm md:text-base opacity-90 max-w-lg">
          ...
          <div className="space-y-4 text-stone-700">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
              <div className="flex gap-5">
                <div className="w-14 h-14 rounded-full bg-white flex items-center justify-center border border-blue-100 flex-shrink-0 shadow-sm">
                  <AlertCircle className="w-7 h-7 text-blue-600" />
                </div>
                <div>
                  <h4 className="font-black text-blue-900 mb-1.5 text-base">
                    Pesan dari Mudir
                  </h4>
                  ...
                  <p className="text-xs text-blue-600 leading-relaxed mt-2 font-bold uppercase tracking-widest">
