...
export default function DashboardPendaftarPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-secondary-50 via-white to-primary-50">
      {/* Header */}
      <header className="bg-white border-b-2 border-primary-200 shadow-sm border border-gray-200">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        {/* Welcome Card */}
        <div className="bg-gradient-to-r from-primary-500 to-primary-600 rounded-lg p-5 md:p-8 mb-8 text-white shadow-sm border border-gray-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {/* Status Pendaftaran */}
          <div className="bg-white rounded-lg p-6 border-2 border-stone-200 shadow-sm border border-gray-200">
