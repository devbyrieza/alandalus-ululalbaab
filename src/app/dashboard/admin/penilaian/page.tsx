                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-center">
                          <div className="flex justify-center items-center gap-1">
                            ...
                            <button
                              ...
                              className="flex items-center gap-1.5 bg-secondary-50 border border-secondary-200 text-secondary-800 px-3 py-1.5 rounded-xl text-[10px] font-black hover:border-secondary-400 transition-all shadow-sm group-hover:scale-105"
                            >
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                      ...
                      <button
                        ...
                        className="flex flex-col items-center justify-center bg-secondary-400 text-primary-900 py-2 rounded-2xl text-[10px] sm:text-[11px] font-black shadow-lg shadow-secondary-400/20 active:scale-95 transition-all"
                      >
                      ...
                      <button
                        ...
                        className="flex flex-col items-center justify-center bg-secondary-200 text-secondary-900 py-2 rounded-2xl text-[10px] sm:text-[11px] font-black shadow-lg shadow-secondary-200/20 active:scale-95 transition-all"
                      >
                        <span className="flex items-center gap-1">
