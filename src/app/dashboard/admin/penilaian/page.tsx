...
export default function ExaminerDashboard() {
  ...
  const fetchStudents = async () => {
    try {
      ...
      const statsRes = await fetch(
        "/api/cron/whatsapp?secret=ppdb-ululalbaab-cron-2026",
      );
  ...
  return (
    <div className="space-y-6 max-w-[1200px] mx-auto pb-10">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-black text-ink-900 tracking-tight flex items-center gap-3">
            <div className="p-4 bg-primary-600 rounded-lg shadow-sm border border-gray-200 shadow-primary-600/20">
        ...
        <div className="flex bg-ink-50 p-1 rounded-lg border border-ink-100 w-fit">
          <button
      ...
      {/* BARU: Banner Akses Khusus & Share WA Bank Soal Panitia (Ulul Albaab Maroon & Krem Emas) */}
      <div style={{ background: "linear-gradient(135deg, #550000 0%, #360000 100%)" }} className="text-white p-5 sm:p-6 rounded-lg shadow-sm border border-gray-200 border border-[#6b0000]/60 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="flex items-center gap-3.5">
          <div className="p-3.5 bg-white/10  rounded-lg border border-white/20 flex-shrink-0">
        ...
        <div className="flex items-center gap-2.5 w-full md:w-auto flex-shrink-0">
          <Link
            ...
            className="flex-1 md:flex-none px-4 py-2.5 bg-[#ddc192] text-[#550000] hover:bg-[#c5a775] rounded-lg font-black text-xs flex items-center justify-center gap-2 shadow-sm transition-all border border-[#ddc192]"
          >
          ...
          <button
            ...
            className="flex-1 md:flex-none px-4 py-2.5 bg-white/10 hover:bg-white/20 text-[#ddc192] border border-[#ddc192]/40 rounded-lg font-bold text-xs flex items-center justify-center gap-2 shadow-sm transition-all"
          >
      ...
      {activeTab === "data" ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <div className="bg-green-50 p-6 rounded-lg shadow-sm border border-gray-200 border border-green-100 relative overflow-hidden">
          ...
          <div className="bg-secondary-50 p-6 rounded-lg shadow-sm border border-gray-200 border border-secondary-100 relative overflow-hidden">
          ...
          <div className="bg-rose-50 p-6 rounded-lg shadow-sm border border-gray-200 border border-rose-100 relative overflow-hidden">
          ...
          <div className="bg-ink-50 p-6 rounded-lg shadow-sm border border-gray-200 border border-ink-200 relative overflow-hidden">
          ...
          <div className="bg-white rounded-lg shadow-clay-md border border-white/40 overflow-hidden">
            <div className="p-6 border-b border-ink-50 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 bg-ink-50/30">
              ...
              <div className="flex flex-wrap gap-2 w-full lg:w-auto">
                <Button
                  ...
                  className="btn-secondary flex items-center gap-2 bg-emerald-50 text-[#550000] border-emerald-100 hover:bg-emerald-100 rounded-lg font-bold py-2"
                >
                ...
                <Button
                  ...
                  className="btn-secondary flex items-center gap-2 bg-purple-50 text-purple-700 border-purple-100 hover:bg-purple-100 rounded-lg font-bold py-2"
                >
                ...
                <Button
                  ...
                  variant="outline"
                  className="rounded-lg border-ink-200"
                >
                      ...
                      >
                        ...
                        <td className="px-4 py-4 whitespace-nowrap">
                          {(() => {
                            ...
                            return (
                              <span
                                className={`px-2.5 py-1 text-[10px] font-black rounded-full border shadow-sm border border-gray-200 ${color}`}
                              >
                                {examStatus || "MENUNGGU"}
                              </span>
                            );
                        ...
                        <td className="px-3 py-4 text-center whitespace-nowrap">
                          {(() => {
                            ...
                            if (isSkipped) {
                              return (
                                <span className="bg-amber-100 text-amber-800 text-[10px] font-black px-2 py-1 rounded shadow-sm border border-gray-200 border border-amber-200">
                                  SKIP
                                </span>
                              );
                            }
                            ...
                            return (
                              <span
                                className={`${color} text-white text-[10px] font-black px-2 py-1 rounded shadow-sm border border-gray-200`}
                              >
                                {grade}
                              </span>
                            );
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-center">
                          <div className="flex justify-center items-center gap-1">
                            {isAdminSuper && (
                              <>
                                <button
                                  ...
                                  className="flex items-center gap-1.5 bg-amber-500 text-white px-3 py-1.5 rounded-lg text-[10px] font-black hover:bg-amber-600 transition-all shadow-sm border border-gray-200 group-hover:scale-105"
                                >
                                  <Zap className="w-3 h-3" /> BYPASS
                                </button>
                                <button
                                  onClick={() => handleOpenAssignDialog(s)}
                                  className="flex items-center gap-1.5 bg-[#550000] text-white px-3 py-1.5 rounded-lg text-[10px] font-black hover:bg-[#550000] transition-all shadow-sm border border-gray-200 group-hover:scale-105"
                                >
                            ...
                            <button
                              ...
                              className="flex items-center gap-1.5 bg-ink-900 text-white px-3 py-1.5 rounded-lg text-[10px] font-black hover:bg-primary-600 transition-all shadow-sm border border-gray-200 group-hover:scale-105"
                            >
                            ...
                            <button
                              ...
                              className="flex items-center gap-1.5 bg-white border border-ink-200 text-ink-700 px-3 py-1.5 rounded-lg text-[10px] font-black hover:border-primary-600 transition-all shadow-sm border border-gray-200 group-hover:scale-105"
                            >
                            ...
                            <button
                              ...
                              className="flex items-center gap-1.5 bg-gold-50 border border-gold-200 text-gold-800 px-3 py-1.5 rounded-lg text-[10px] font-black hover:border-gold-400 transition-all shadow-sm border border-gray-200 group-hover:scale-105"
                            >
            ...
            <div className="md:hidden space-y-3 p-6 sm:p-8">
              {loading ? (
                ...
                filteredStudents.map((s) => (
                  <div
                    key={s.id}
                    className="bg-white rounded-lg p-5 shadow-clay-sm border border-ink-50 space-y-4"
                  >
                    ...
                    <div className="flex items-start justify-between gap-3 flex-wrap">
                      ...
                      {/* Total Badge */}
                      <div className="bg-primary-600 px-4 py-2.5 rounded-lg text-white text-center shrink-0">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
                      {[
                        ...
                        <div
                          key={item.label}
                          className="bg-ink-50 rounded-lg p-4.5 text-center"
                        >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                      {isAdminSuper && (
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 col-span-full">
                          <button
                            onClick={() => handleOpenSkipDialog(s)}
                            className="flex items-center justify-center gap-2 bg-amber-500 text-white py-3 rounded-lg text-[11px] font-black shadow-sm border border-gray-200 shadow-amber-500/20 active:scale-95 transition-all"
                          >
                            <Zap className="w-3.5 h-3.5" /> BYPASS
                          </button>
                          <button
                            onClick={() => handleOpenAssignDialog(s)}
                            className="flex items-center justify-center gap-2 bg-[#550000] text-white py-3 rounded-lg text-[11px] font-black shadow-sm border border-gray-200 shadow-blue-500/20 active:scale-95 transition-all"
                          >
                      ...
                      <button
                        onClick={() => handleOpenInput(s, "quran")}
                        className="flex items-center justify-center gap-2 bg-ink-900 text-white py-3 rounded-lg text-[11px] font-black shadow-sm border border-gray-200 shadow-ink-900/10 active:scale-95 transition-all"
                      >
                        <Zap className="w-3.5 h-3.5" /> TES QUR&apos;AN
                      </button>
                      <button
                        onClick={() => handleOpenInput(s, "wawancara_santri")}
                        className="flex flex-col items-center justify-center bg-gold-400 text-primary-900 py-2 rounded-lg text-[10px] sm:text-[11px] font-black shadow-sm border border-gray-200 shadow-gold-400/20 active:scale-95 transition-all"
                      >
                      ...
                      <button
                        ...
                        className="flex flex-col items-center justify-center bg-gold-200 text-gold-900 py-2 rounded-lg text-[10px] sm:text-[11px] font-black shadow-sm border border-gray-200 shadow-gold-200/20 active:scale-95 transition-all"
                      >
                        <span className="flex items-center gap-1">
        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-500">
          ...
          {isProcessingQueue && (
            <div className="bg-primary-600 rounded-lg p-6 text-white shadow-sm border border-gray-200 shadow-primary-600/20 overflow-hidden relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-lg p-6 shadow-clay-md border border-white/40 flex items-center gap-4">
              <div className="p-6 sm:p-8 bg-secondary-50 text-secondary-600 rounded-lg">
            ...
            <div className="bg-white rounded-lg p-6 shadow-clay-md border border-white/40 flex items-center gap-4">
              <div className="p-6 sm:p-8 bg-green-50 text-[#550000] rounded-lg">
            ...
            <div className="bg-white rounded-lg p-6 shadow-clay-md border border-white/40 flex items-center gap-4">
              <div className="p-6 sm:p-8 bg-red-50 text-red-600 rounded-lg">
          ...
          <div className="bg-white rounded-lg shadow-clay-md border border-white/40 overflow-hidden">
            <div className="p-5 md:p-8 space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pb-4">
                <div className="p-6 bg-primary-50/30 rounded-lg border border-primary-100/50 hover:bg-primary-50 transition-colors">
                  ...
                  <Button
                    ...
                    className="w-full bg-primary-600 hover:bg-primary-700 text-white rounded-lg py-6 font-black text-base shadow-sm border border-gray-200 shadow-primary-600/20"
                  >
                    {isBroadcasting
                      ? "Memproses..."
                ...
                <div className="p-6 bg-emerald-50/30 rounded-lg border border-emerald-100/50 hover:bg-emerald-50 transition-colors">
                  ...
                  <Button
                    ...
                    className="w-full bg-[#550000] hover:bg-[#550000] text-white rounded-lg py-6 font-black text-base shadow-sm border border-gray-200 shadow-emerald-600/20 disabled:bg-slate-200 disabled:text-slate-400 disabled:shadow-none"
                  >
                    {isProcessingQueue
      ...
      {assignStudent && typeof document !== "undefined" && createPortal(
        ...
        >
          <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-sm border border-gray-200 transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full border border-white/20">
              <div className="bg-white px-6 pt-8 pb-6 sm:p-5 md:p-8">
                ...
                <div className="bg-ink-50 rounded-lg p-6 sm:p-8 mb-6 border border-ink-100">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-ink-50 border border-ink-100 rounded-lg px-4 py-3 text-sm font-bold text-ink-900 focus:ring-2 focus:ring-primary-600/10 outline-none"
                    >
              ...
              <div className="bg-ink-50 px-6 py-6 sm:px-5 md:px-8 sm:flex sm:flex-row-reverse gap-3 border-t border-ink-100">
                <Button
                  ...
                  className="w-full sm:w-auto bg-primary-600 hover:bg-primary-700 text-white rounded-lg px-5 md:px-8 py-3 font-black shadow-sm border border-gray-200 shadow-primary-600/20"
                >
                  Simpan Penugasan
                </Button>
                <button
                  type="button"
                  onClick={() => setAssignStudent(null)}
                  className="mt-3 sm:mt-0 w-full sm:w-auto bg-white border border-ink-200 text-ink-600 hover:bg-ink-100 rounded-lg px-5 md:px-8 py-3 font-black shadow-sm border border-gray-200 transition-all"
                >
                  Batal
                </button>
              </div>
            ...
            <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-sm border border-gray-200 transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full border border-white/20">
                      ...
                      {[
                        ...
                        <div key={f.k}>
                          ...
                          <select
                            ...
                            className="w-full bg-ink-50 border border-ink-100 rounded-lg px-3 py-2 text-sm font-bold text-ink-900 focus:ring-2 focus:ring-primary-600/10 outline-none"
                          >
              ...
              <div className="bg-ink-50 px-6 py-6 sm:px-5 md:px-8 sm:flex sm:flex-row-reverse gap-3 border-t border-ink-100">
                <Button
                  ...
                  className="w-full sm:w-auto bg-primary-600 hover:bg-primary-700 text-white rounded-lg px-5 md:px-8 py-3 font-black shadow-sm border border-gray-200 shadow-primary-600/20 disabled:opacity-50"
                >
