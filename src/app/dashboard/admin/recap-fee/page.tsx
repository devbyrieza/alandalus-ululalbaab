        ...
        <div className="relative flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex gap-2 md:gap-3">
            ...
            <Button
              ...
              disabled={loading}
              variant="outline"
              className="rounded-2xl h-11 md:h-12 px-4 md:px-6 border-ink-100 hover:bg-brand-yellow-50 font-black"
            >
              <RefreshCcw
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4">
          ...
          <div className="col-span-2 md:col-span-1 bg-linear-to-br from-brand-blue-700 to-brand-blue-900 rounded-[1.5rem] md:rounded-[2rem] p-5 md:p-6 shadow-clay-md relative overflow-hidden">
            ...
            <p className="text-[9px] font-bold text-brand-yellow-300 mt-2 uppercase tracking-tight">
            ...
            <tbody className="divide-y divide-ink-50">
              {loading ? (
                ...
                filteredRecap.map((item) => (
                  <tr
                    key={item.id}
                    className="group hover:bg-brand-blue-50/20 transition-all"
                  >
                    <td className="px-6 py-6">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <p className="text-sm font-black text-ink-900 group-hover:text-brand-blue-700 transition-colors uppercase">
                            {item.name}
                          </p>
        ...
        <div className="md:hidden divide-y divide-ink-50">
          {loading ? (
            ...
            filteredRecap.map((item) => (
              <div
                key={item.id}
                className="p-5 bg-white hover:bg-brand-blue-50/10 transition-colors"
              >
                {/* Name + Honor Row */}
            ...
            <div className="p-5 bg-ink-900 text-white rounded-b-[2.5rem]">
              <div className="flex flex-col gap-2">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-xl font-black text-brand-yellow-400">
                    {formatCurrency(totals.grandTotalFee)}
                  </span>
                </div>
