    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-20">
      ...
      <div className="bg-white rounded-[2rem] md:rounded-[2.5rem] p-5 md:p-8 shadow-clay-lg border border-white/40 overflow-hidden relative">
        ...
        <div className="relative flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
          <div className="flex items-center gap-4 md:gap-6">
            <div className="p-3 md:p-4 bg-linear-to-br from-blue-600 to-blue-800 rounded-2xl md:rounded-3xl shadow-xl shadow-blue-600/20 shrink-0">
          ...
          <div className="flex gap-2 md:gap-3">
            ...
            <Button
              ...
              disabled={loading}
              variant="outline"
              className="rounded-2xl h-11 md:h-12 px-4 md:px-6 border-ink-100 hover:bg-amber-50 font-black"
            >
              <RefreshCcw
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4">
          ...
          <div className="col-span-2 md:col-span-1 bg-linear-to-br from-blue-700 to-blue-900 rounded-[1.5rem] md:rounded-[2rem] p-5 md:p-6 shadow-clay-md relative overflow-hidden">
            ...
            <p className="text-[9px] font-bold text-amber-300 mt-2 uppercase tracking-tight">
                ...
                <div key={field.id}>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-ink-50 border-none rounded-xl pl-8 pr-4 py-2 text-sm font-black text-ink-900 focus:ring-2 focus:ring-blue-600/20"
                    />
                  </div>
                </div>
              ))}
                  ...
                  >
                    <td className="px-6 py-6">
                      <div className="flex items-center gap-4">
                        <div className="w-10 h-10 rounded-2xl bg-amber-100 flex items-center justify-center text-blue-900 font-black shadow-sm border border-amber-200">
                          {item.name.charAt(0)}
                        </div>
                        <div>
                          <p className="text-sm font-black text-ink-900 group-hover:text-blue-700 transition-colors uppercase">
                            {item.name}
                          </p>
            ...
            {!loading && filteredRecap.length > 0 && (
              <tfoot className="bg-ink-900 text-white">
                <tr>
                  ...
                  <td className="px-6 py-6 text-right text-xl font-black text-amber-400">
                    {formatCurrency(totals.grandTotalFee)}
                  </td>
                </tr>
              </tfoot>
        ...
        <div className="md:hidden divide-y divide-ink-50">
          {loading ? (
            ...
            filteredRecap.map((item) => (
              <div
                key={item.id}
                className="p-5 bg-white hover:bg-blue-50/10 transition-colors"
              >
                {/* Name + Honor Row */}
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-11 h-11 rounded-2xl bg-amber-100 flex items-center justify-center text-blue-900 font-black text-lg border border-amber-200 shrink-0">
                    {item.name.charAt(0)}
                  </div>
                ...
                <div className="mb-3 bg-linear-to-r from-blue-700 to-blue-800 rounded-2xl px-4 py-3 flex items-center justify-between">
                  <div>
