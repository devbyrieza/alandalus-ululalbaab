 ...
 * Navigasi utama panel admin dengan fitur responsif dan multi-role.
 */
export default function AdminSidebar({
  ...
  return (
    <div className="min-h-screen bg-[#f0f8ff] font-sans selection:bg-primary-100 selection:text-primary-900">
      {/* MOBILE HEADER */}
