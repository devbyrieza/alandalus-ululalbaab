    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-[2rem] shadow-sm p-5 md:p-8 border border-stone-100">
        <div className="flex flex-col xl:flex-row xl:items-center gap-4 xl:justify-between flex-wrap">
          <div className="flex flex-wrap sm:flex-nowrap items-center gap-4">
            <div className="w-12 h-12 md:w-16 md:h-16 bg-primary-50 rounded-lg flex items-center justify-center border border-primary-100 shrink-0">
          ...
          {canVerify && (
            <div className="relative z-20 flex-shrink-0">
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white rounded-lg text-sm font-bold transition-all shadow-sm shadow-primary-600/20 whitespace-nowrap"
              >
          ...
          <div className="flex flex-wrap items-center gap-2 flex-shrink-0 mt-2 xl:mt-0">
            <button
              ...
              disabled={exporting}
              className="flex items-center gap-2 px-3 md:px-4 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg font-bold transition-all shadow-sm hover:shadow-sm disabled:opacity-50 text-sm"
            ...
            <button
              ...
              disabled={exporting}
              className="flex items-center gap-2 px-3 md:px-4 py-2.5 bg-rose-600 hover:bg-rose-700 text-white rounded-lg font-bold transition-all shadow-sm hover:shadow-sm disabled:opacity-50 text-sm"
              title="Download PDF"
            >
              {exporting ? (
                <Loader2 className="w-4 h-4 animate-spin" />
            ...
            <button
              ...
              className="flex items-center gap-2 px-3 md:px-6 py-2.5 bg-white hover:bg-stone-50 border border-stone-200 text-stone-700 rounded-lg font-bold transition-all shadow-sm hover:shadow-sm text-sm"
            >
      ...
      <div className="relative group">
        ...
        <input
          ...
          className="w-full pl-12 pr-4 py-4 bg-white border border-stone-200 rounded-lg focus:border-primary-500 focus:ring-4 focus:ring-primary-500/5 focus:outline-none transition-all text-sm md:text-base font-bold text-stone-800 placeholder:text-stone-400 shadow-sm"
        />
      </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-6">
                  <div className="flex-1">
                    ...
                    <div className="flex items-start gap-4 mb-3">
                      <div className="w-12 h-12 rounded-lg bg-primary-50 flex items-center justify-center text-primary-800 font-black text-lg shrink-0 border border-primary-100">
                    ...
                    {/* Details Grid */}
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 ml-0 sm:ml-16 mt-3 sm:mt-0 bg-stone-50/50 p-4 rounded-lg border border-stone-100">
                      <div>
                  ...
                  <div className="flex sm:flex-col gap-3 sm:w-48 shrink-0">
                    <button
                      ...
                      className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 py-2.5 bg-white border-2 border-dashed border-stone-300 hover:border-primary-500 hover:bg-primary-50 text-stone-600 hover:text-primary-800 rounded-lg text-sm font-bold transition-all"
                    >
                    ...
                    {statusFilter === "pending" && (
                      <button
                        onClick={() => openModal(pay)}
                        className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 py-3 bg-primary-700 hover:bg-primary-800 text-white rounded-lg text-sm font-bold shadow-sm shadow-primary-700/20 transition-all hover:-translate-y-0.5"
                      >
                    ...
                    {statusFilter === "rejected" && (
                      <button
                        onClick={() => openModal(pay)}
                        className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 py-3 bg-red-50 hover:bg-red-100 text-red-700 rounded-lg font-bold text-sm border border-red-100 transition-all"
                      >
      ...
      {showModal && selectedPembayaran && (
        <div onWheel={(e) => e.stopPropagation()} data-modal="true" aria-modal="true" role="dialog" className="fixed inset-0 bg-black/60  flex items-start md:items-center pt-10 md:pt-0 pb-20 md:pb-0 justify-center z-50 p-4 animate-in fade-in duration-200 overflow-y-auto overflow-x-hidden overscroll-contain custom-scrollbar">
          <div className="bg-white rounded-[2rem] shadow-sm max-w-2xl w-full max-h-[90vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-200">
            {/* Header - Fixed */}
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6 overscroll-contain custom-scrollbar">
              ...
              {activeTab === "DAFTAR_ULANG" && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 bg-violet-50 rounded-lg border border-violet-100">
                  <div>
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          className="w-full px-4 py-2 bg-white border border-violet-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-500 font-black text-violet-900"
                        />
                      </div>
              ...
              {selectedPembayaran.keringanan_reason && (
                <div className="p-5 bg-secondary-50 border-2 border-secondary-100 rounded-lg space-y-3 shadow-sm">
                  ...
                  <p className="text-sm text-secondary-900 leading-relaxed font-bold italic bg-white/50 p-4 rounded-lg border border-secondary-200/50">
                    "{selectedPembayaran.keringanan_reason}"
                  </p>
              ...
              {selectedPembayaran.bukti_transfer_url ? (
                <div className="space-y-2">
                  ...
                  <div className="border-2 border-stone-100 rounded-lg overflow-hidden bg-stone-50 relative group">
                    {selectedPembayaran.bukti_transfer_url
                      ?.toLowerCase()
                      .endsWith(".pdf") ? (
                      <iframe
                    ...
                    <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                      <a
                        ...
                        className="px-6 py-3 bg-white rounded-full font-bold text-stone-900 shadow-sm hover:scale-105 transition-transform flex items-center gap-2"
                      >
                        <Eye className="w-4 h-4" />
                        Lihat Full Size
                      </a>
                ...
                <div className="p-5 md:p-8 border-2 border-dashed border-stone-200 rounded-lg text-center space-y-4">
                  <p className="text-stone-500 font-medium">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 border border-stone-200 rounded-lg focus:border-primary-600 focus:ring-2 focus:ring-primary-600/20 focus:outline-none resize-none transition-all font-bold text-stone-800"
                  rows={3}
                />
              </div>
            </div>
            ...
            <div className="p-6 border-t border-stone-100 bg-stone-50/50 flex flex-col sm:flex-row gap-3">
              <div className="flex-1 flex gap-3">
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-2 px-4 py-4 bg-emerald-500 hover:bg-emerald-600 text-white rounded-lg font-bold transition-all hover:shadow-sm hover:shadow-emerald-500/20 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {processing ? (
                ...
                <button
                  ...
                  disabled={processing}
                  className="flex-1 flex items-center justify-center gap-2 px-4 py-4 bg-rose-500 hover:bg-rose-600 text-white rounded-lg font-bold transition-all hover:shadow-sm hover:shadow-rose-500/20 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {processing ? (
                    <Loader2 className="w-5 h-5 animate-spin" />
                  ) : (
