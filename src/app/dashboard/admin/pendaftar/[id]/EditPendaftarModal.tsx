...
export default function EditPendaftarModal({
  ...
  return (
    <div onWheel={(e) => e.stopPropagation()} role="dialog" aria-modal="true" data-modal="true" className="fixed inset-0 bg-black/60  flex items-start md:items-center pt-10 md:pt-0 pb-20 md:pb-0 justify-center z-50 p-4 overflow-y-auto overflow-x-hidden overscroll-contain custom-scrollbar">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-stone-50 border border-stone-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-600 font-bold text-stone-800"
                />
              </div>
              <div className="space-y-1">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-1">
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-4 py-3 bg-stone-50 border border-stone-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-600 font-bold text-stone-800 resize-none"
                />
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-1">
