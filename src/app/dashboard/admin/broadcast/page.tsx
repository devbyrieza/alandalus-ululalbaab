                        ...
                        <div className="flex-1 overflow-y-auto p-4 space-y-2">
                            {loading ? (
                                ...
                                <div className="flex flex-col items-center justify-center h-full text-ink-400">
                                    ...
                                    <p className="text-sm font-medium">Tidak ada pendaftar ditemukan</p>
                                </div>
                            ) : (
                ...
                <div className="lg:col-span-5 space-y-6">
                    <div className="bg-white rounded-2xl shadow-clay-md border border-white/40 p-6 space-y-6 sticky top-28">
                        ...
                        <div className="space-y-4">
                            <div>
                                <label className="block text-xs font-bold text-ink-400 uppercase tracking-wider mb-2">Header (Opsional)</label>
                                <input
                                    type="text"
                                    value={header}
                            ...
                            <div>
                                <label className="block text-xs font-bold text-ink-400 uppercase tracking-wider mb-2">Isi Pesan</label>
                                <textarea
                                    rows={8}
                                    value={message}
                            ...
                            <div>
                                <label className="block text-xs font-bold text-ink-400 uppercase tracking-wider mb-2">Footer (Opsional)</label>
                                <input
                                    type="text"
                                    value={footer}
                        ...
                        {results && (
                            <div className={`p-4 rounded-xl flex items-start gap-3 ${results.failed > 0 ? "bg-red-50 text-red-700" : "bg-green-50 text-green-700"}`}>
                                {results.failed > 0 ? <AlertCircle className="w-5 h-5 mt-0.5" /> : <CheckCircle2 className="w-5 h-5 mt-0.5" />}
                                <div className="text-sm font-bold">
                                    Broadcast Selesai: {results.sent} Berhasil, {results.failed} Gagal
                                </div>
                            </div>
                        )}
                    </div>
