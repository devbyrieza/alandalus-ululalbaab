        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                    <div className="w-12 h-12 bg-primary-600 rounded-lg flex items-center justify-center text-white shadow-sm border border-gray-200 shadow-primary-600/20">
            ...
            {/* Conflict Warning */}
            {conflicts.length > 0 && (
                <div className="bg-red-50 border-2 border-red-200 rounded-lg p-6 md:p-8 animate-pulse shadow-sm border border-gray-200 shadow-red-500/10">
                    <div className="flex items-start gap-5">
                        <div className="w-14 h-14 bg-red-100 rounded-lg flex items-center justify-center text-red-600 shrink-0 border border-red-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-6">
                <div className="bg-white rounded-lg p-4 md:p-6 border border-slate-100 shadow-clay-sm relative overflow-hidden group">
                ...
                <div className="flex flex-col md:flex-row gap-3">
                    ...
                    <div className="flex-1 flex gap-2">
                        <div className="relative flex-1">
                            ...
                            <input 
                                ...
                                className="w-full bg-white border border-slate-200 rounded-lg pl-10 pr-4 py-2 text-sm focus:ring-4 focus:ring-primary-500/5 focus:border-primary-500 outline-none font-bold h-12 transition-all shadow-sm"
                            />
                        </div>
                        <select 
                            value={filterJenjang}
                            onChange={(e) => setFilterJenjang(e.target.value)}
                            className="w-32 bg-white border border-slate-200 rounded-lg px-3 py-2 text-[11px] font-black text-ink-600 focus:ring-4 focus:ring-primary-500/5 focus:border-primary-500 outline-none h-12 shadow-sm appearance-none text-center uppercase tracking-wider"
                        >
                    ...
                    <div className="flex items-center gap-2">
                        <div className="flex-1 md:flex-none flex bg-slate-100 p-1.5 rounded-lg h-12 min-w-fit">
                            {[
                                ...
                                <button 
                                    ...
                                    className={`px-5 rounded-lg text-[11px] font-bold uppercase tracking-wider transition-all ${viewMode === mode.id ? "bg-white text-primary-700 shadow-sm" : "text-slate-400 hover:text-slate-600"}`}
                                >
                                    {mode.label}
                                </button>
                            ))}
                        ...
                        <button 
                            ...
                            className="w-12 h-12 bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 rounded-lg shadow-sm transition-all flex items-center justify-center shrink-0"
                            title="Refresh Data"
                        >
                        ...
                        <button 
                            ...
                            className={`px-4 rounded-lg text-[11px] font-bold uppercase tracking-wider transition-all border h-12 shadow-sm ${
                                showPast 
            ...
            <div className="space-y-6">
                {loading ? (
                    <div className="bg-white rounded-lg shadow-clay-lg p-24 text-center border border-white/40">
                    ...
                    <>
                        ...
                        <div className="grid grid-cols-1 gap-4 md:hidden">
                            {filteredSchedules.map((s) => (
                                <div key={s.id} className="bg-white rounded-[2.5rem] border border-slate-100 shadow-clay-m p-6 space-y-4">
                                    ...
                                    <div className="flex items-center gap-2 text-[11px] text-slate-500 font-bold px-3 py-2 bg-slate-50 rounded-lg">
                        ...
                        {/* Desktop View: Table */}
                        <div className="hidden md:block bg-white rounded-lg shadow-clay-lg overflow-hidden border border-white/40">
                        ...
                        {getGroupedSchedules().map((group) => (
                            <div key={group.name} className="bg-white rounded-[2rem] shadow-clay-m border border-slate-100 overflow-hidden">
                                <div className="bg-slate-50 px-7 py-5 flex items-center justify-between border-b border-slate-100/50">
                                    <div className="flex items-center gap-4">
                                        <div className="w-11 h-11 bg-primary-600 rounded-lg flex items-center justify-center text-white shadow-sm border border-gray-200 shadow-primary-600/20">
                            ...
                            <div key={group.name} className="bg-white rounded-[2rem] shadow-clay-m border border-slate-100 overflow-hidden flex flex-col transition-all hover:translate-y-[-4px] group">
                                ...
                                <div className="p-5 flex-1 space-y-4">
                                    {group.items.map((s, idx) => (
                                        <div key={`${s.id}-${idx}`} className="bg-slate-50/30 rounded-lg p-4 border border-slate-100/50">
