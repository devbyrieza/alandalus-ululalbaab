      ...
      <div className="relative overflow-hidden rounded-4xl bg-linear-to-br from-brand-blue-700 to-brand-blue-900 p-10 md:p-16 text-white shadow-2xl app-card border border-brand-blue-600">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-10">
          <div>
            ...
            <p className="text-brand-blue-100 font-bold opacity-90 text-sm md:text-lg max-w-md">Ikhtisar real-time calon santri Al-Andalus Ulul Albaab Tahun Ajaran {tahunAjaranList.find(t => t.id === selectedTahunAjaranId)?.nama || "..."}.</p>
          </div>
