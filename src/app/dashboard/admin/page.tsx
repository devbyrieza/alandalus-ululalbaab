...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="relative max-w-[1400px] mx-auto space-y-6 sm:space-y-8 pb-20 px-1">
      ...
      <div className="bg-linear-to-br from-primary-800 via-primary-700 to-blue-950 rounded-[2.5rem] lg:rounded-[3rem] p-6 sm:p-5 md:p-8 lg:p-6 md:p-12 text-white relative overflow-hidden shadow-[0_32px_64px_-16px_rgba(30,58,138,0.4)] border border-white/10">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
          <div className="max-w-xl w-full">
            ...
            <div className="flex items-center gap-8 sm:gap-12 mt-8 lg:mt-12">
              ...
              <div>
                <span className="text-3xl sm:text-3xl md:text-5xl font-black text-secondary-400 drop-shadow-md">{stats.sudah_bayar}</span>
      ...
      {(isAdminSuper || isAdminBerkas || isAdminKeuangan) && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
          <div className="bg-linear-to-br from-primary-800 to-primary-950 rounded-[1.5rem] sm:rounded-[2rem] lg:rounded-[2.5rem] p-5 sm:p-5 md:p-8 lg:p-6 md:p-10 text-white relative overflow-hidden group shadow-[0_16px_40px_-12px_rgba(30,58,138,0.4)] border border-white/5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8">
                <div className="space-y-6 sm:space-y-8">
                  ...
                  <div>
                    ...
                    <p className="text-2xl sm:text-2xl md:text-4xl font-black text-primary-300">{stats.sudah_isi_data}</p>
                  </div>
                  <div>
          ...
          <div className="bg-white rounded-[1.5rem] sm:rounded-[2rem] lg:rounded-[2.5rem] border border-ink-100 p-5 sm:p-5 md:p-8 lg:p-6 md:p-10 shadow-premium-sm relative overflow-hidden group">
            <div className="relative z-10">
              ...
              <div className="space-y-4">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 sm:p-6 bg-primary-50 rounded-2xl sm:rounded-3xl border border-primary-100 hover:border-primary-200 transition-all cursor-default group/item gap-4">
                  ...
                  <div className="flex items-center justify-between sm:justify-end gap-3 w-full sm:w-auto border-t sm:border-0 pt-3 sm:pt-0 border-primary-100 flex-wrap">
