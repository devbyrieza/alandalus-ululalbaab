  ...
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
      ...
      <div className="relative z-10">
        ...
        {breakdown && (
          <div className="grid grid-cols-2 gap-4 pt-6 border-t border-ink-100">
  ...
  return (
    <div className="max-w-[1400px] mx-auto space-y-8 pb-20">
      <div className="flex items-center justify-between">
        ...
        <button onClick={fetchStats} className="p-3 bg-white border border-ink-100 rounded-2xl text-ink-400 hover:text-brand-blue-600 transition-all shadow-premium-sm">
