    ...
    <div className="relative max-w-[1400px] mx-auto space-y-6 sm:space-y-8 pb-20 px-1">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
          <div className="max-w-xl w-full">
            ...
            <div className="flex items-center gap-8 sm:gap-12 mt-8 lg:mt-12">
              ...
              <div>
                <span className="text-3xl sm:text-3xl md:text-5xl font-black text-secondary-400 italic">{stats.sudah_bayar}</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 w-full lg:w-auto">
            ...
            <div className="bg-primary-600 p-4 sm:p-6 lg:p-5 md:p-8 rounded-[1.5rem] sm:rounded-[2rem] border border-white/10 flex flex-col items-center">
              ...
              <p className="text-2xl sm:text-2xl md:text-4xl font-black text-secondary-400 italic">{stats.daftar_ulang_sedang}</p>
            </div>
            <div className="bg-primary-600 p-4 sm:p-6 lg:p-5 md:p-8 rounded-[1.5rem] sm:rounded-[2rem] border border-white/10 flex flex-col items-center">
      ...
      {(isAdminSuper || isAdminBerkas || isAdminKeuangan) && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
          <div className="bg-primary-700 rounded-[1.5rem] sm:rounded-[2rem] lg:rounded-[2.5rem] p-5 sm:p-5 md:p-8 lg:p-6 md:p-10 text-white relative overflow-hidden group">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8">
                <div className="space-y-6 sm:space-y-8">
                  ...
                  <div>
                    ...
                    <p className="text-2xl sm:text-2xl md:text-4xl font-black text-primary-300 italic">{stats.sudah_isi_data}</p>
                  </div>
                  <div>
                    <p className="text-[10px] font-black text-primary-200 uppercase tracking-widest mb-2">Proses Daftar Ulang</p>
                ...
                <div className="space-y-6 sm:space-y-8 pl-4 sm:pl-10 border-l border-white/20">
                  ...
                  <div>
                    <p className="text-[10px] font-black text-primary-200 uppercase tracking-widest mb-2">Lunas Daftar Ulang</p>
                    <p className="text-2xl sm:text-2xl md:text-4xl font-black text-emerald-400 italic">{stats.daftar_ulang_selesai}</p>
                  </div>
                </div>
              </div>
