...
/**
 * ─── ADMIN DASHBOARD PAGE (ULUL ALBAAB) ───
 */
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="grid grid-cols-2 gap-4 w-full lg:w-auto">
             <div className="bg-white/5 backdrop-blur-md p-6 rounded-[2rem] border border-white/5">
                <p className="text-[9px] font-black text-slate-500 uppercase tracking-widest mb-4">Lulus Seleksi</p>
                <p className="text-3xl font-black text-emerald-400 italic">{stats.diterima}</p>
             </div>
             <div className="bg-white/5 backdrop-blur-md p-6 rounded-[2rem] border border-white/5">
                <p className="text-[9px] font-black text-slate-500 uppercase tracking-widest mb-4">Daftar Ulang</p>
                <p className="text-3xl font-black text-blue-400 italic">{stats.daftar_ulang}</p>
             </div>
          </div>
        </div>
      </div>
