      ...
      <div className="bg-brand-blue-950 rounded-[2rem] sm:rounded-[2.5rem] lg:rounded-[3rem] p-6 sm:p-8 lg:p-12 text-white relative overflow-hidden shadow-2xl border border-white/5">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
          ...
          <div className="grid grid-cols-2 gap-4 sm:gap-6 w-full lg:w-auto">
            ...
            <div className="bg-white/5 backdrop-blur-md p-4 sm:p-6 lg:p-8 rounded-[1.5rem] sm:rounded-[2rem] border border-white/10 flex flex-col items-center">
              <p className="text-[9px] sm:text-[10px] font-black text-brand-blue-200 uppercase tracking-widest mb-2 sm:mb-4 text-center">Daftar Ulang</p>
              <p className="text-2xl sm:text-4xl font-black text-brand-yellow-400 italic">{stats.daftar_ulang}</p>
            </div>
          </div>
        </div>
      </div>
