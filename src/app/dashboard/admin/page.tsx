...
export default function AdminDashboardPage() {
  ...
  if (loading && stats.total_pendaftar === 0) return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4">
      ...
      <p className="text-sm font-bold text-brand-blue-400 tracking-widest animate-pulse uppercase">Sinkronisasi Data...</p>
    </div>
  );
  ...
  return (
    <div className="max-w-[1400px] mx-auto space-y-6 sm:space-y-8 pb-20 px-1">
      ...
      <div className="bg-brand-blue-950 rounded-[2rem] sm:rounded-[2.5rem] lg:rounded-[3rem] p-6 sm:p-8 lg:p-12 text-white relative overflow-hidden shadow-2xl border border-white/5">
        <div className="absolute top-0 right-0 w-96 h-96 bg-brand-blue-600/20 rounded-full blur-[100px] -translate-y-1/2 translate-x-1/2" />
        <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
          <div className="max-w-xl w-full">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-6xl font-black mb-4 sm:mb-6 tracking-tighter leading-tight italic text-white">
              Pantau <span className="text-brand-yellow-400">Pendaftaran</span>
            </h2>
            <div className="flex items-center gap-8 sm:gap-12 mt-8 lg:mt-12">
              <div>
                ...
                <p className="text-[10px] sm:text-[11px] font-black text-brand-blue-200 uppercase tracking-widest mt-2">Pendaftar</p>
              </div>
              <div className="w-px h-12 sm:h-16 bg-white/20" />
              <div>
                <span className="text-3xl sm:text-5xl font-black text-brand-yellow-400 italic">{stats.sudah_bayar}</span>
                <p className="text-[10px] sm:text-[11px] font-black text-brand-blue-200 uppercase tracking-widest mt-2">Bayar Pendaftaran</p>
              </div>
            </div>
          </div>
          <div className="grid grid-cols-2 gap-4 sm:gap-6 w-full lg:w-auto">
            <div className="bg-white/5 backdrop-blur-md p-4 sm:p-6 lg:p-8 rounded-[1.5rem] sm:rounded-[2rem] border border-white/10 flex flex-col items-center">
              <p className="text-[9px] sm:text-[10px] font-black text-brand-blue-200 uppercase tracking-widest mb-2 sm:mb-4 text-center">Diterima</p>
              <p className="text-2xl sm:text-4xl font-black text-emerald-400 italic">{stats.diterima}</p>
            </div>
            <div className="bg-white/5 backdrop-blur-md p-4 sm:p-6 lg:p-8 rounded-[1.5rem] sm:rounded-[2rem] border border-white/10 flex flex-col items-center">
              <p className="text-[9px] sm:text-[10px] font-black text-brand-blue-200 uppercase tracking-widest mb-2 sm:mb-4 text-center">Sedang Daftar Ulang</p>
              <p className="text-2xl sm:text-4xl font-black text-brand-yellow-400 italic">{stats.daftar_ulang_sedang}</p>
            </div>
            <div className="bg-white/5 backdrop-blur-md p-4 sm:p-6 lg:p-8 rounded-[1.5rem] sm:rounded-[2rem] border border-white/10 flex flex-col items-center">
              <p className="text-[9px] sm:text-[10px] font-black text-brand-blue-200 uppercase tracking-widest mb-2 sm:mb-4 text-center">Selesai</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
          ...
          <div className="bg-white rounded-[1.5rem] sm:rounded-[2rem] lg:rounded-[2.5rem] border border-ink-100 p-5 sm:p-8 lg:p-10 shadow-premium-sm relative overflow-hidden group">
            <div className="relative z-10">
              ...
              <div className="space-y-4">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 sm:p-6 bg-brand-blue-50 rounded-2xl sm:rounded-3xl border border-brand-blue-100 hover:border-brand-blue-200 transition-all cursor-default group/item gap-4">
                  <div className="flex items-center gap-4 sm:gap-5">
                    <div className="w-12 h-12 rounded-2xl bg-white shadow-sm flex items-center justify-center text-brand-blue-600 transition-transform group-hover/item:scale-110 shrink-0">
                  ...
                  <div className="flex items-center justify-between sm:justify-end gap-3 w-full sm:w-auto border-t sm:border-0 pt-3 sm:pt-0 border-brand-blue-100">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 sm:p-6 bg-brand-blue-50 rounded-2xl sm:rounded-3xl border border-brand-blue-100 hover:border-emerald-200 transition-all cursor-default group/item gap-4">
                  <div className="flex items-center gap-4 sm:gap-5">
