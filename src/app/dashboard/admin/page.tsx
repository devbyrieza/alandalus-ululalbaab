...
const StatWidget = ({ label, value, icon: Icon, color, trend }: any) => {
    const colors: any = {
        ...
        yellow: "text-brand-yellow-600 bg-brand-yellow-50"
    };
    ...
    return (
        <div className="bg-white p-6 rounded-2xl border border-slate-200/60 shadow-sm hover:shadow-md transition-all group">
            <div className="flex items-start justify-between mb-4">
                <div className={`p-2.5 rounded-xl ${colors[color] || colors.blue} transition-transform group-hover:scale-110`}>
  ...
  return (
    <div className="max-w-[1400px] mx-auto space-y-8 pb-20">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <h1 className="text-3xl font-black text-slate-900 tracking-tight mb-2">Dashboard Ulul Albaab</h1>
        ...
        <div className="flex items-center gap-3">
          ...
          <button 
            ...
            className="p-2.5 bg-white border border-slate-200 rounded-xl text-slate-500 hover:text-brand-blue-600 hover:border-brand-blue-200 transition-all shadow-sm"
            title="Refresh Data"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8">
            <div className="relative overflow-hidden rounded-[2rem] bg-slate-900 p-8 md:p-10 text-white shadow-xl shadow-slate-950/20 group">
                <div className="absolute top-0 right-0 w-64 h-64 bg-brand-blue-500/10 rounded-full blur-[80px] -translate-y-1/2 translate-x-1/2 pointer-events-none" />
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                    <div className="max-w-md">
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/10 text-[10px] font-bold uppercase tracking-widest mb-6">
                            <Clock className="w-3.5 h-3.5 text-brand-blue-400" />
                            <span>Status Pendaftaran</span>
                        </div>
                        <h2 className="text-3xl md:text-4xl font-black mb-4 tracking-tight leading-tight">
                            {daysLeft} Hari Lagi Menuju <span className="text-brand-blue-400">Penutupan</span>
                        </h2>
                        ...
                        <div className="flex items-center gap-6">
                            ...
                            <div className="flex flex-col">
                                <span className="text-2xl font-black text-brand-blue-400">{stats.sudah_bayar}</span>
                    ...
                    <Link href="/dashboard/admin/pendaftar" className="shrink-0 group/btn">
                        <div className="flex items-center justify-center w-32 h-32 rounded-full border-2 border-white/10 hover:border-brand-blue-500/50 transition-colors relative">
        ...
        <div className="lg:col-span-4 flex flex-col gap-4">
            <div className="flex-1 bg-brand-blue-600 rounded-[2rem] p-8 text-white relative overflow-hidden shadow-lg shadow-brand-blue-900/20">
                ...
                <p className="text-brand-blue-50 text-sm font-medium mb-6 leading-relaxed opacity-80">Export seluruh data pendaftar Ulul Albaab ke format Excel.</p>
                <button className="w-full bg-white text-brand-blue-900 py-4 rounded-xl font-black text-[11px] uppercase tracking-widest hover:bg-slate-50 transition-all flex items-center justify-center gap-2">
            ...
            <div className="flex-1 bg-white border border-slate-200 rounded-[2rem] p-8 shadow-sm">
                ...
                <div className="space-y-3">
                    <Link href="/dashboard/admin/verifikasi-pembayaran" className="flex items-center justify-between p-3 rounded-xl hover:bg-slate-50 transition-colors group">
                        <span className="text-xs font-bold text-slate-600 group-hover:text-brand-blue-600">Bayar Pendaftaran</span>
                    ...
                    <Link href="/dashboard/admin/verifikasi-dokumen" className="flex items-center justify-between p-3 rounded-xl hover:bg-slate-50 transition-colors group">
                        <span className="text-xs font-bold text-slate-600 group-hover:text-brand-blue-600">Berkas Dokumen</span>
      ...
      <div className="bg-white rounded-[2.5rem] border border-slate-200 shadow-sm overflow-hidden">
          <div className="px-8 py-6 border-b border-slate-100 flex items-center justify-between">
              <div>
                ...
                <p className="text-[11px] text-slate-400 font-bold uppercase tracking-widest mt-1">Distribusi Santri Ulul Albaab</p>
              </div>
                              ...
                              <tr key={idx} className="hover:bg-slate-50/40 transition-colors group">
                                  <td className="px-8 py-5">
                                      <div className="flex items-center gap-4">
                                          <div className="w-9 h-9 rounded-xl bg-slate-100 flex items-center justify-center text-brand-blue-700 font-black text-xs border border-slate-200">
                                  ...
                                  <td className="px-4 py-5 text-center">
                                      <div className="flex items-center justify-center gap-1.5 text-xs font-bold">
                                          <span className="text-brand-blue-600">{item.pendaftar_putra}</span>
                                      ...
                                      <div className="w-full max-w-[120px] ml-auto">
                                          ...
                                          <div className="h-1.5 w-full bg-slate-100 rounded-full overflow-hidden">
                                              <motion.div 
                                                ...
                                                className={`h-full rounded-full ${percentage > 80 ? 'bg-brand-blue-500' : 'bg-slate-400'}`} 
                                              />
                                          </div>
                                      </div>
                                  </td>
