          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {filteredIl.map((q, idx) => (
              <div key={idx} className="bg-white p-5 rounded-lg border border-slate-200 shadow-sm space-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-[11px] font-extrabold px-2.5 py-1 bg-emerald-100 text-emerald-800 rounded-lg whitespace-nowrap inline-block shrink-0">
                    SOAL #{idx + 1} (IL)
                  </span>
                  <span className="text-xs font-semibold text-slate-400">Poin: 5.0</span>
                </div>
                ...
                <div className="grid grid-cols-1 gap-2 pt-2">
                  {q.options.map((opt) => (
                    <div
                      ...
                      className="p-2.5 rounded-lg bg-slate-50 border border-slate-100 text-xs font-medium text-slate-700 flex items-start gap-2"
                    >
                      <span className="font-bold text-emerald-700 bg-emerald-100 px-2 py-0.5 rounded-md whitespace-nowrap inline-block shrink-0">
                        {opt.value}
                      </span>
                      <span>{opt.label}</span>
                    </div>
        ...
        <div className="space-y-4">
          <div className="bg-amber-50 border border-amber-200 text-amber-900 p-4 rounded-lg text-xs md:text-sm flex items-start gap-3">
            ...
            <div className="space-y-1">
              ...
              <div className="mt-2 p-2.5 bg-amber-100/70 border border-amber-300 rounded-lg text-amber-950 font-semibold text-xs whitespace-nowrap inline-block shrink-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {filteredMa.map((q, idx) => (
              <div key={idx} className="bg-white p-5 rounded-lg border border-slate-200 shadow-sm space-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-[11px] font-extrabold px-2.5 py-1 bg-amber-100 text-amber-800 rounded-lg whitespace-nowrap inline-block shrink-0">
                    SOAL #{idx + 1} (MA / SMA)
                  </span>
                  <span className="text-xs font-semibold text-slate-400">Poin: 5.0</span>
                </div>
                ...
                <div className="grid grid-cols-1 gap-2 pt-2">
                  {q.options.map((opt) => (
                    <div
                      ...
                      className="p-2.5 rounded-lg bg-slate-50 border border-slate-100 text-xs font-medium text-slate-700 flex items-start gap-2"
                    >
                      <span className="font-bold text-amber-700 bg-amber-100 px-2 py-0.5 rounded-md whitespace-nowrap inline-block shrink-0">
                        {opt.value}
                      </span>
                      <span>{opt.label}</span>
                    </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {filteredKepribadian.map((q) => (
              <div key={q.id} className="bg-white p-5 rounded-lg border border-slate-200 shadow-sm space-y-3">
                <span className="text-[11px] font-extrabold px-2.5 py-1 bg-purple-100 text-purple-800 rounded-lg whitespace-nowrap inline-block shrink-0">
                  PASANGAN #{q.id}
                </span>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-white p-5 rounded-lg border border-emerald-300 shadow-sm space-y-3 relative overflow-hidden">
              ...
              <span className="px-3 py-1 bg-emerald-100 text-emerald-800 rounded-full text-xs font-extrabold whitespace-nowrap inline-block shrink-0">
            ...
            <div className="bg-white p-5 rounded-lg border border-amber-300 shadow-sm space-y-3 relative overflow-hidden">
              ...
              <span className="px-3 py-1 bg-amber-100 text-amber-800 rounded-full text-xs font-extrabold whitespace-nowrap inline-block shrink-0">
