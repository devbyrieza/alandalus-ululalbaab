...
function PindahanContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setShowModal(false);
      setForm({ nama_lengkap:"",nik:"",jenis_kelamin:"P",jenjang:"MTs",kelas_masuk:"8",asal_institusi:"",nomor_induk_lama:"",catatan_pindahan:"",no_hp:"",email:"",tempat_lahir:"",tanggal_lahir:"",tahun_ajaran_id:"",status_pendaftaran:"submitted" });
      fetchData();
