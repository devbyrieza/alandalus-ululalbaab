              ...
              {roleSelectionData ? (
                ...
                >
                  ...
                  <motion.button
                    ...
                    type="submit"
                    disabled={isLoading}
                    className="w-full py-4 md:py-6 rounded-pill bg-secondary-400 text-primary-900 font-black text-lg md:text-xl hover:bg-secondary-500 shadow-xl shadow-secondary-100 border border-secondary-300 transition-all flex items-center justify-center gap-3 disabled:opacity-50"
                  >
                    {isLoading ? (
                      <Loader2 className="w-6 h-6 animate-spin" />
                    ) : (
