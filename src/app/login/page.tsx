...
> = {
  ...
  admin_keuangan: {
    ...
    color: "from-emerald-50 to-blue-50 border-emerald-200",
  },
...
const AuthInput = ({
  ...
  <div className="space-y-3">
    ...
    <div className="relative group">
      <div className="absolute left-5 md:left-6 top-0 bottom-0 flex items-center text-ink-500 group-focus-within:text-blue-600 transition-colors duration-300 pointer-events-none">
...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-white flex items-center justify-center p-6 relative overflow-hidden">
      {/* Background Decor */}
      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-amber-100/40 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/2 pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-blue-100/20 rounded-full blur-[100px] -translate-x-1/2 translate-y-1/2 pointer-events-none" />
      ...
      <Container className="relative z-10 flex flex-col items-center">
        ...
        >
          <Link href="/">
            <div className="app-card inline-flex items-center justify-center w-20 h-20 bg-white rounded-3xl shadow-sm border border-blue-100 mb-8 hover:scale-110 transition-transform group overflow-hidden">
              <img
        ...
        <motion.div
          ...
          className="app-card w-full max-w-[480px] bg-white rounded-[2.5rem] md:rounded-[4rem] shadow-lg border border-blue-100 p-6 md:p-14 relative overflow-hidden"
        >
          ...
          {!roleSelectionData && (
            <div className="bg-slate-100 p-2 rounded-[2rem] flex relative mb-12 border border-slate-200">
              ...
              <button
                ...
                className={`flex-1 relative z-10 py-3.5 text-xs font-black uppercase tracking-widest text-center rounded-2xl transition-colors duration-300 ${activeTab === "pendaftar" ? "text-blue-700" : "text-ink-600 hover:text-ink-800"}`}
              >
                Pendaftar
              </button>
              <button
                ...
                className={`flex-1 relative z-10 py-3.5 text-xs font-black uppercase tracking-widest text-center rounded-2xl transition-colors duration-300 ${activeTab === "admin" ? "text-blue-700" : "text-ink-600 hover:text-ink-800"}`}
              >
                Portal Staf
              </button>
            </div>
              ...
              {roleSelectionData ? (
                ...
                >
                  <div className="text-center mb-6">
                    <div className="w-14 h-14 bg-amber-100 rounded-2xl flex items-center justify-center mx-auto mb-4 border border-amber-200">
                ...
                >
                  <AuthInput label="Nomor Pendaftaran" icon={FileText}>
                    <input
                      ...
                      className="w-full px-5 py-3 md:px-8 md:py-5 pl-14 md:pl-16 rounded-xl md:rounded-2xl bg-slate-50 border border-slate-200 focus:bg-white focus:border-blue-300 focus:ring-4 focus:ring-blue-50 transition-all font-bold text-ink-950 uppercase placeholder:normal-case placeholder:font-medium placeholder:text-ink-400 text-sm md:text-base shadow-inner"
                      disabled={isLoading}
                    />
                  </AuthInput>
                  ...
                  <AuthInput label="NIK Calon Santri" icon={IdCard}>
                    <input
                      ...
                      className="w-full px-5 py-3 md:px-8 md:py-5 pl-14 md:pl-16 rounded-xl md:rounded-2xl bg-slate-50 border border-slate-200 focus:bg-white focus:border-blue-300 focus:ring-4 focus:ring-blue-50 transition-all font-bold text-ink-950 placeholder:font-medium placeholder:text-ink-400 text-sm md:text-base shadow-inner"
                      disabled={isLoading}
                    />
                  </AuthInput>
                  ...
                  <motion.button
                    ...
                    type="submit"
                    disabled={isLoading}
                    className="w-full py-4 md:py-6 rounded-pill bg-blue-700 text-white font-black text-lg md:text-xl hover:bg-blue-800 shadow-xl shadow-blue-100 transition-all flex items-center justify-center gap-3 disabled:opacity-50"
                  >
                    {isLoading ? (
                  ...
                  <div className="text-center pt-4">
                    ...
                    <Link
                      href="/daftar"
                      className="inline-flex items-center gap-2 px-10 py-3 rounded-pill bg-cream-50 text-blue-700 font-black text-sm border border-cream-200 hover:bg-white hover:shadow-sm transition-all"
                    >
                      Daftar Baru Di Sini
                    </Link>
                  </div>
                ...
                >
                  ...
                  >
                    <input
                      ...
                      placeholder="••••••••"
                      className="w-full px-5 py-3 md:px-8 md:py-5 pl-14 md:pl-16 pr-12 md:pr-16 rounded-xl md:rounded-2xl bg-slate-50 border border-slate-200 focus:bg-white focus:border-blue-300 focus:ring-4 focus:ring-blue-50 transition-all font-bold text-ink-950 placeholder:font-medium placeholder:text-ink-400 text-sm md:text-base shadow-inner"
                      disabled={isLoading}
                    />
                  </AuthInput>
                  ...
                  <motion.button
                    ...
                    type="submit"
                    disabled={isLoading}
                    className="w-full py-4 md:py-6 rounded-pill bg-amber-400 text-blue-900 font-black text-lg md:text-xl hover:bg-amber-500 shadow-xl shadow-amber-100 border border-amber-300 transition-all flex items-center justify-center gap-3 disabled:opacity-50"
                  >
                    {isLoading ? (
                      <Loader2 className="w-6 h-6 animate-spin" />
                    ) : (
                  ...
                  <div className="p-6 bg-cream-50/50 rounded-3xl border border-amber-100 flex items-start gap-4">
                    <div className="w-8 h-8 rounded-xl bg-amber-100 flex items-center justify-center text-blue-700 shrink-0">
        ...
        >
          <Link
            href="/"
            className="group flex items-center gap-3 text-ink-600 hover:text-blue-700 font-black uppercase tracking-[0.2em] text-[10px] transition-all"
          >
