...
const ContactInfoCard = ({
  ...
  <motion.div
    ...
    className="app-card bg-white p-6 sm:p-5 md:p-8 rounded-lg sm:rounded-[2.5rem] border border-primary-100 shadow-sm hover:shadow-sm transition-all group flex flex-col items-center text-center"
  >
...
const SocialCard = ({ social, delay = 0 }: { social: any; delay?: number }) => (
  <motion.a
    ...
    className={`app-card group flex items-center gap-4 sm:gap-5 p-4 sm:p-5 rounded-lg sm:rounded-[2rem] bg-white border border-primary-50 shadow-sm hover:shadow-sm transition-all`}
  >
    <div
        ...
        <Container>
          <div className="grid lg:grid-cols-5 gap-10 lg:gap-24 items-start">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="lg:col-span-3 bg-white p-6 md:p-16 rounded-[2.5rem] md:rounded-[4rem] shadow-sm border border-primary-50 relative overflow-hidden"
            >
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 md:gap-5 mb-8 md:mb-12">
                  <div className="w-12 h-12 md:w-16 md:h-16 bg-primary-900 rounded-lg md:rounded-lg flex items-center justify-center text-white shadow-sm shrink-0">
                ...
                >
                  ...
                  <motion.button
                    ...
                    className="w-full py-4 md:py-6 rounded-pill bg-primary-900 text-white font-black text-lg md:text-xl hover:bg-secondary-600 shadow-sm transition-all flex items-center justify-center gap-3 disabled:opacity-50"
                  >
            ...
            <div className="lg:col-span-2 space-y-8 md:space-y-12">
              <div className="space-y-4 md:space-y-6">
                ...
                >
                  Ikuti{" "}
                  <span className="text-primary-600">Media Sosial</span>
                </motion.h2>
              ...
              >
                <div className="rounded-[2rem] md:rounded-[2.5rem] overflow-hidden h-[300px] md:h-[400px] relative border border-surface-50">
                  ...
                  />
                  <div className="absolute bottom-3 left-3 md:bottom-6 md:left-6 bg-white  px-3 py-1.5 md:px-6 md:py-3 rounded-lg md:rounded-lg shadow-sm border border-primary-100 flex items-center gap-1.5 md:gap-3 z-10">
