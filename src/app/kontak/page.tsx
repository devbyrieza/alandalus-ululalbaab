...
const ContactInfoCard = ({
  ...
  >
    ...
    <h3 className="text-xl font-display font-black text-brand-blue-950 mb-3">
      {title}
    </h3>
    {href ? (
      <a
        href={href}
        className="text-lg font-bold text-brand-blue-600 hover:text-brand-blue-700 transition-colors break-all"
      >
        {content}
      </a>
    ) : (
...
const SocialCard = ({ social, delay = 0 }: { social: any; delay?: number }) => (
  ...
  >
    <div
      className={`w-14 h-14 rounded-2xl ${social.bgLight} flex items-center justify-center ${social.textColor} group-hover:scale-110 transition-transform shadow-sm border border-brand-blue-50`}
    >
          ...
          <div className="grid lg:grid-cols-5 gap-10 lg:gap-24 items-start">
            ...
            <div className="lg:col-span-2 space-y-8 md:space-y-12">
              <div className="space-y-4 md:space-y-6">
                ...
                >
                  Ikuti{" "}
                  <span className="text-brand-blue-600">Media Sosial</span>
                </motion.h2>
          ...
          >
            ...
            <div className="relative z-10">
              <h2 className="text-xl sm:text-2xl md:text-4xl lg:text-5xl xl:text-6xl font-display font-black mb-4 sm:mb-6 md:mb-8 text-white leading-tight">
                Mari Bergabung <br />{" "}
                <span className="text-brand-yellow-100">Menjadi Keluarga</span>
              </h2>
              <p className="text-sm sm:text-base md:text-lg lg:text-xl text-brand-blue-50 max-w-2xl mx-auto mb-6 sm:mb-8 md:mb-10 lg:mb-12 font-medium px-2">
                Kami menunggu kehadiran Anda di Pesantren Al Andalus Ulul
                Albaab. Pendaftaran santri baru telah dibuka!
              </p>
