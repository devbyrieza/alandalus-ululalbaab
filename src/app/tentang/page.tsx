      ...
      <section className="py-12 md:py-20 lg:py-24 bg-white overflow-hidden border-t border-primary-100/50">
        <Container>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ delay: 0.2 }}
            className="relative aspect-video md:aspect-[21/9] max-h-[480px] w-full rounded-[2rem] md:rounded-[3rem] overflow-hidden shadow-sm border border-gray-200 border border-primary-100 group bg-gradient-to-br from-primary-950 to-primary-900"
          >
            <Image
      ...
      <section className="section-alt border-y border-primary-100">
        <Container>
          <div className="grid lg:grid-cols-1 md:grid-cols-2 gap-12 sm:gap-16 lg:gap-24 items-center">
            ...
            >
              <div className="aspect-[4/5] max-h-[520px] min-h-[350px] w-full rounded-[2.5rem] md:rounded-[3rem] overflow-hidden shadow-sm border border-gray-200 relative z-10 bg-white p-3 border border-primary-100">
              ...
              <motion.div
                ...
                className="absolute -bottom-6 right-0 sm:-bottom-10 sm:-right-6 md:-bottom-12 md:-right-10 z-20 bg-white p-5 md:p-8 rounded-lg md:rounded-[2rem] shadow-sm border border-gray-200 border border-primary-100 max-w-[85vw] sm:max-w-[90vw] md:max-w-none"
              >
                <div className="flex items-center gap-4 md:gap-5">
                  <div className="w-12 h-12 md:w-16 md:h-16 bg-linear-to-br from-primary-600 to-primary-800 rounded-lg md:rounded-lg flex items-center justify-center text-white shadow-sm border border-gray-200 shrink-0">
            ...
            <div className="space-y-8 order-1 lg:order-2">
              ...
              >
                ...
                <p className="font-bold text-primary-800 bg-primary-50/50 p-6 sm:p-8 rounded-lg border border-primary-100 italic text-center text-lg mt-6">
              ...
              >
                <div className="app-card bg-white p-5 md:p-6 flex flex-col items-start group">
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-lg bg-orange-50 flex items-center justify-center mb-4 text-orange-600 group-hover:scale-110 transition-transform shadow-sm border border-gray-200">
                ...
                <div className="app-card bg-white p-5 md:p-6 flex flex-col items-start group">
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-lg bg-primary-50 flex items-center justify-center mb-4 text-primary-600 group-hover:scale-110 transition-transform shadow-sm border border-gray-200">
      ...
      <section className="section-std relative">
        ...
        <Container className="relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-6 lg:gap-8">
            ...
            >
              <div className="w-14 h-14 bg-primary-50 rounded-lg flex items-center justify-center mb-6 text-primary-600 group-hover:scale-110 transition-transform duration-500 shadow-sm border border-gray-200">
            ...
            >
              <div className="w-14 h-14 bg-yellow-50 rounded-lg flex items-center justify-center mb-6 text-yellow-600 group-hover:scale-110 transition-transform duration-500 shadow-sm border border-gray-200">
              ...
              <ul className="space-y-4 md:space-y-6 flex-1">
                {[
                  ...
                  <li key={idx} className="flex gap-4 items-center group/item">
                    <div className="w-6 h-6 rounded-full bg-yellow-500 text-white flex items-center justify-center text-[10px] font-bold shrink-0 shadow-sm border border-gray-200">
            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6 mb-8">
                <div className="w-14 h-14 bg-white rounded-lg flex items-center justify-center text-primary-700 group-hover:scale-110 transition-transform duration-500 border border-primary-100 shadow-sm border border-gray-200 shrink-0">
              ...
              <ul className="grid md:grid-cols-2 gap-x-8 lg:gap-x-12 gap-y-6">
                {[
                  ...
                  <li
                    key={idx}
                    className="flex gap-4 items-start group/item bg-white p-5 rounded-lg border border-primary-50 shadow-sm border border-gray-200"
                  >
                    <div className="w-6 h-6 rounded-full bg-primary-600 text-white flex items-center justify-center text-[10px] font-bold shrink-0 mt-0.5 shadow-sm border border-gray-200">
                      <CheckCircle2 className="w-3.5 h-3.5" />
                    </div>
      ...
      <section className="py-16 md:py-24 lg:py-32 relative overflow-hidden bg-white border-t border-primary-100">
        <Container>
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-primary-900 bg-linear-to-br from-primary-800 to-primary-950 rounded-[2.5rem] md:rounded-[3rem] lg:rounded-[4rem] p-5 md:p-8 sm:p-6 lg:p-24 relative overflow-hidden text-center shadow-sm border border-gray-200 border border-primary-700"
          >
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center px-4">
                <Link href="/ppdb" className="w-full sm:w-auto">
                  <button className="w-full px-5 md:px-8 py-4 sm:py-4.5 rounded-pill bg-white text-primary-900 font-bold text-base md:text-lg shadow-sm border border-gray-200 hover:bg-secondary-100 hover:shadow-sm border border-gray-200 transition-all duration-300 min-h-[52px]">
                    Daftar Sekarang
                  </button>
                </Link>
