        ...
        <Container>
          <div className="mb-10 lg:mb-16 text-center">
            ...
            >
              ...
              <span className="text-[10px] md:text-xs font-black uppercase tracking-[0.3em] text-brand-blue-700">
                Ahlan Wa Sahlan
              </span>
              <div className="w-8 h-0.5 bg-brand-blue-600/30 rounded-full" />
            </motion.div>
            <h2 className="section-title text-center text-3xl sm:text-4xl md:text-5xl lg:text-6xl leading-[1.1] mb-0">
              ...
              Dimulai dari{" "}
              <span className="text-brand-blue-700 underline decoration-brand-blue-500/30 underline-offset-4 md:underline-offset-8">
                Sini
              </span>
            </h2>
          </div>
              ...
              >
                <div className="flex items-center gap-4 md:gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-brand-blue-700 font-bold text-[9px] md:text-[10px] uppercase tracking-widest mb-1.5 md:mb-2">
                      Era Baru
                    </p>
              ...
              >
                <div className="space-y-4 md:space-y-6 text-base md:text-[17px] text-ink-700 font-medium leading-[1.8] text-justify">
                  <p>
                    ...
                    <span className="text-brand-blue-700 italic font-bold">
            ...
            >
              ...
              <ul className="grid md:grid-cols-2 gap-x-8 lg:gap-x-12 gap-y-6">
                {[
                  ...
                  <li
                    key={idx}
                    className="flex gap-4 items-start group/item bg-white p-5 rounded-2xl border border-brand-blue-50 shadow-sm"
                  >
          ...
          >
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black mb-6 md:mb-8 text-white tracking-tight leading-[1.1]">
                ...
                Keluarga{" "}
                <span className="text-brand-yellow-300">Ulul Albaab</span>
              </h2>
