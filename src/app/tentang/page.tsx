  ...
  return (
    <main className="bg-white min-h-screen">
      ...
      <section className="section-std pb-0! relative overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-amber-100/60 rounded-full blur-[100px] -translate-y-1/2 translate-x-1/2 pointer-events-none" />
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-blue-50/40 rounded-full blur-[100px] translate-y-1/2 -translate-x-1/2 pointer-events-none" />
        ...
        <Container className="relative z-10 text-center">
          ...
          >
            Babak Baru <br />
            <span className="text-gradient-blue pb-2 block sm:inline">
              Pendidikan Qur'ani
            </span>
          </motion.h1>
      ...
      <section className="py-12 md:py-20 lg:py-24 bg-white overflow-hidden border-t border-blue-100/50">
        <Container>
          <div className="mb-10 lg:mb-16 text-center">
            <motion.div
              ...
              viewport={{ once: true }}
              className="inline-flex items-center gap-3 text-blue-700 mb-4"
            >
              <div className="w-8 h-0.5 bg-blue-600/30 rounded-full" />
              <span className="text-[10px] md:text-xs font-black uppercase tracking-[0.3em] text-blue-700">
                Ahlan Wa Sahlan
              </span>
              <div className="w-8 h-0.5 bg-blue-600/30 rounded-full" />
            </motion.div>
            <h2 className="section-title text-center text-3xl sm:text-4xl md:text-5xl lg:text-6xl leading-[1.1] mb-0">
              ...
              Dimulai dari{" "}
              <span className="text-blue-700 underline decoration-blue-500/30 underline-offset-4 md:underline-offset-8">
                Sini
              </span>
            </h2>
          </div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ delay: 0.2 }}
            className="relative aspect-video md:aspect-21/9 rounded-[2rem] md:rounded-[3rem] overflow-hidden shadow-lg border border-blue-100 group"
          >
            <Image
      ...
      <section className="section-alt border-y border-blue-100">
        <Container>
          <div className="grid lg:grid-cols-2 gap-12 sm:gap-16 lg:gap-24 items-center">
            ...
            >
              <div className="aspect-4/5 rounded-[2.5rem] md:rounded-[3rem] overflow-hidden shadow-xl relative z-10 bg-white p-3 border border-blue-100">
              ...
              <motion.div
                ...
                className="absolute -bottom-6 right-0 sm:-bottom-10 sm:-right-6 md:-bottom-12 md:-right-10 z-20 bg-white p-5 md:p-8 rounded-2xl md:rounded-[2rem] shadow-lg border border-blue-100 max-w-[85vw] sm:max-w-[90vw] md:max-w-none"
              >
                <div className="flex items-center gap-4 md:gap-5">
                  <div className="w-12 h-12 md:w-16 md:h-16 bg-linear-to-br from-blue-600 to-blue-800 rounded-xl md:rounded-2xl flex items-center justify-center text-white shadow-sm shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-blue-700 font-bold text-[9px] md:text-[10px] uppercase tracking-widest mb-1.5 md:mb-2">
                      Era Baru
                    </p>
                    <div className="text-[9px] md:text-[10px] font-bold text-blue-900 bg-blue-50 px-2.5 py-1.5 rounded-lg border border-blue-100 leading-tight">
            ...
            <div className="space-y-8 order-1 lg:order-2">
              ...
              >
                ...
                <div className="w-20 h-1.5 bg-blue-600 rounded-full mb-8 lg:mb-10" />
              </motion.div>
              ...
              >
                <div className="space-y-4 md:space-y-6 text-base md:text-[17px] text-ink-700 font-medium leading-[1.8] text-justify">
                  ...
                  <p>
                    ...
                    ternama di 3 Benua, termasuk Arab Saudi, Mesir, Maroko, dan
                    berbagai Perguruan Tinggi Negeri terbaik dalam negeri.
                    Alumni Ulul Albaab pun diarahkan untuk melanjutkan studi ke
                  ...
                  <p className="font-bold text-blue-800 bg-blue-50/50 p-4 rounded-xl border border-blue-100 italic text-center text-lg mt-6">
              ...
              >
                ...
                <div className="app-card bg-white p-5 md:p-6 flex flex-col items-start group">
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-blue-50 flex items-center justify-center mb-4 text-blue-600 group-hover:scale-110 transition-transform shadow-sm">
      ...
      <section className="section-std relative">
        <div className="absolute top-0 left-0 w-[400px] h-[400px] bg-amber-100/50 rounded-full blur-[100px] -translate-y-1/2 -translate-x-1/2 opacity-50 pointer-events-none" />
        <Container className="relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-20">
            <motion.span
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="text-blue-700 font-bold tracking-[0.2em] uppercase text-[10px] xl:text-xs mb-3 block"
            >
              Landasan Dasar
            </motion.span>
            <motion.h2
          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-6 lg:gap-8">
            ...
            >
              <div className="w-14 h-14 bg-blue-50 rounded-2xl flex items-center justify-center mb-6 text-blue-600 group-hover:scale-110 transition-transform duration-500 shadow-sm">
                <Target className="w-7 h-7" />
              </div>
              <h3 className="text-xl md:text-2xl font-black text-ink-950 mb-5">
                Visi
              </h3>
              <p className="text-lg md:text-xl font-black text-blue-800 italic leading-[1.5] md:leading-[1.4] flex-1">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ delay: 0.2 }}
              className="app-card bg-linear-to-br from-amber-50 to-white p-8 md:p-10 flex flex-col group h-full hover:-translate-y-1 transition-transform duration-500"
            >
              <div className="w-14 h-14 bg-amber-50 rounded-2xl flex items-center justify-center mb-6 text-amber-600 group-hover:scale-110 transition-transform duration-500 shadow-sm">
              ...
              <ul className="space-y-4 md:space-y-6 flex-1">
                {[
                  ...
                  <li key={idx} className="flex gap-4 items-center group/item">
                    <div className="w-6 h-6 rounded-full bg-amber-500 text-white flex items-center justify-center text-[10px] font-bold shrink-0 shadow-sm">
                      <CheckCircle2 className="w-3.5 h-3.5" />
                    </div>
                    <span className="text-ink-800 font-bold text-[13px] md:text-sm tracking-tight group-hover/item:text-amber-700 transition-colors pt-0.5">
                      {item}
                    </span>
                  </li>
                ))}
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ delay: 0.1 }}
              className="md:col-span-2 app-card bg-amber-100/50 p-8 md:p-10 lg:p-12 hover:-translate-y-1 transition-transform duration-500 group"
            >
              <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6 mb-8">
                <div className="w-14 h-14 bg-white rounded-2xl flex items-center justify-center text-blue-700 group-hover:scale-110 transition-transform duration-500 border border-blue-100 shadow-sm shrink-0">
              ...
              <ul className="grid md:grid-cols-2 gap-x-8 lg:gap-x-12 gap-y-6">
                {[
                  ...
                  <li
                    key={idx}
                    className="flex gap-4 items-start group/item bg-white p-5 rounded-2xl border border-blue-50 shadow-sm"
                  >
                    <div className="w-6 h-6 rounded-full bg-blue-600 text-white flex items-center justify-center text-[10px] font-bold shrink-0 mt-0.5 shadow-sm">
                      <CheckCircle2 className="w-3.5 h-3.5" />
                    </div>
                    <span className="text-ink-700 font-medium text-[13.5px] md:text-sm tracking-tight group-hover/item:text-blue-800 transition-colors leading-normal">
                      {item}
                    </span>
                  </li>
                ))}
      ...
      <section className="py-16 md:py-24 lg:py-32 relative overflow-hidden bg-white border-t border-blue-100">
        <Container>
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-blue-900 bg-linear-to-br from-blue-800 to-blue-950 rounded-[2.5rem] md:rounded-[3rem] lg:rounded-[4rem] p-8 sm:p-12 md:p-16 lg:p-24 relative overflow-hidden text-center shadow-lg border border-blue-700"
          >
            {/* Decorative background */}
            <div className="hidden sm:block absolute top-0 right-0 w-48 h-48 sm:w-64 sm:h-64 md:w-96 md:h-96 bg-blue-50/10 rounded-full blur-[80px] md:blur-[100px] -translate-y-1/2 translate-x-1/2" />
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black mb-6 md:mb-8 text-white tracking-tight leading-[1.1]">
                ...
                Keluarga{" "}
                <span className="text-amber-300">Ulul Albaab</span>
              </h2>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center px-4">
                <Link href="/ppdb" className="w-full sm:w-auto">
                  <button className="w-full px-8 py-4 sm:py-4.5 rounded-pill bg-white text-blue-900 font-bold text-base md:text-lg shadow-md hover:bg-amber-100 hover:shadow-lg transition-all duration-300 min-h-[52px]">
                    Daftar Sekarang
                  </button>
                </Link>
